...
class Zeilfelder2025ModelForHumanLiverCancerCellModel2503270001Model(TelluriumSBMLBioModule):
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'input_il6_level': ('input_il6', 10.0, 'native SBML value', 'Input il6 source parameter. Maps to bundled SBML parameter `input_il6`.'), 'il6_basal_level': ('il6_basal', 0.00957067090828757, 'native SBML value', 'Il6 basal source parameter. Maps to bundled SBML parameter `il6_basal`.'), 'il6_act_level': ('il6_act', 0.0226985677410744, 'native SBML value', 'Il6 act source parameter. Maps to bundled SBML parameter `il6_act`.'), 'dcf_il6_basal_level': ('dcf_il6_basal', 0.835096746625705, 'native SBML value', 'Dcf il6 basal source parameter. Maps to bundled SBML parameter `dcf_il6_basal`.'), 'initial_unphosphorylated_stat3': ('STAT3', 1237.76392668883, 'native SBML value', 'Initial Unphosphorylated STAT3. Sets the initial value of bundled SBML symbol `STAT3`.'), 'initial_active_cytoplasmic_stat3': ('cpSTAT3', 24.1373740148803, 'native SBML value', 'Initial Active cytoplasmic STAT3. Sets the initial value of bundled SBML symbol `cpSTAT3`.')}
