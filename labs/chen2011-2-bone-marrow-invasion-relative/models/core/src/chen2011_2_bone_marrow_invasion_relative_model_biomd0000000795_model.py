...
class Chen20112BoneMarrowInvasionRelativeModelBiomd0000000795Model(TelluriumSBMLBioModule):
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'initial_healthy_bone_marrow': ('H', 0.5, 'native SBML value', 'Initial Healthy Bone Marrow. Sets the initial value of bundled SBML symbol `H`.'), 'initial_tumor_burden': ('T', 0.0001, 'native SBML value', 'Initial Tumor Burden. Sets the initial value of bundled SBML symbol `T`.')}
