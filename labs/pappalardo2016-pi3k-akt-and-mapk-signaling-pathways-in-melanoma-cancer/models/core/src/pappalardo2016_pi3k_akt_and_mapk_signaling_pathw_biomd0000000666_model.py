...
class Pappalardo2016Pi3kAktAndMapkSignalingPathwBiomd0000000666Model(TelluriumSBMLBioModule):
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'initial_rasinactive': ('species_5', 120000.0, 'native SBML value', 'Initial RasInactive. Sets the initial value of bundled SBML symbol `species_5`.'), 'initial_raf1inactive': ('species_7', 120000.0, 'native SBML value', 'Initial Raf1Inactive. Sets the initial value of bundled SBML symbol `species_7`.'), 'initial_erkinactive': ('species_11', 600000.0, 'native SBML value', 'Initial ErkInactive. Sets the initial value of bundled SBML symbol `species_11`.'), 'initial_pi3kinactive': ('species_15', 120000.0, 'native SBML value', 'Initial PI3KInactive. Sets the initial value of bundled SBML symbol `species_15`.'), 'initial_aktinactive': ('species_17', 120000.0, 'native SBML value', 'Initial AktInactive. Sets the initial value of bundled SBML symbol `species_17`.'), 'initial_brafmutated': ('bRafMutated', 120000.0, 'native SBML value', 'Initial BRafMutated. Sets the initial value of bundled SBML symbol `bRafMutated`.')}
    _HEADLINE_OUTPUTS = {'rasinactive': ('species_5', 'native SBML value', 'RasInactive observable. Maps to SBML symbol `species_5`.'), 'raf1inactive': ('species_7', 'native SBML value', 'Raf1Inactive observable. Maps to SBML symbol `species_7`.'), 'erkinactive': ('species_11', 'native SBML value', 'ErkInactive observable. Maps to SBML symbol `species_11`.'), 'pi3kinactive': ('species_15', 'native SBML value', 'PI3KInactive observable. Maps to SBML symbol `species_15`.'), 'aktinactive': ('species_17', 'native SBML value', 'AktInactive observable. Maps to SBML symbol `species_17`.'), 'brafmutated': ('bRafMutated', 'native SBML value', 'BRafMutated observable. Maps to SBML symbol `bRafMutated`.')}
