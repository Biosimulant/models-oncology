...
class Orton2009ModellingCancerousMutationsInTheEBiomd0000000623Model(TelluriumSBMLBioModule):
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'initial_free_egfreceptor': ('species_1', 80000.0, 'native SBML value', 'Initial FreeEGFReceptor. Sets the initial value of bundled SBML symbol `species_1`.'), 'initial_bound_egfreceptor': ('species_0', 0.0, 'native SBML value', 'Initial BoundEGFReceptor. Sets the initial value of bundled SBML symbol `species_0`.'), 'initial_degraded_egfreceptor': ('species_18', 0.0, 'native SBML value', 'Initial DegradedEGFReceptor. Sets the initial value of bundled SBML symbol `species_18`.'), 'initial_ras_inactive': ('species_5', 120000.0, 'native SBML value', 'Initial RasInactive. Sets the initial value of bundled SBML symbol `species_5`.'), 'initial_raf1_inactive': ('species_7', 120000.0, 'native SBML value', 'Initial Raf1Inactive. Sets the initial value of bundled SBML symbol `species_7`.'), 'initial_erk_inactive': ('species_11', 600000.0, 'native SBML value', 'Initial ErkInactive. Sets the initial value of bundled SBML symbol `species_11`.')}
    _HEADLINE_OUTPUTS = {'free_egfreceptor': ('species_1', 'native SBML value', 'FreeEGFReceptor observable. Maps to SBML symbol `species_1`.'), 'bound_egfreceptor': ('species_0', 'native SBML value', 'BoundEGFReceptor observable. Maps to SBML symbol `species_0`.'), 'degraded_egfreceptor': ('species_18', 'native SBML value', 'DegradedEGFReceptor observable. Maps to SBML symbol `species_18`.'), 'ras_inactive': ('species_5', 'native SBML value', 'RasInactive observable. Maps to SBML symbol `species_5`.'), 'raf1_inactive': ('species_7', 'native SBML value', 'Raf1Inactive observable. Maps to SBML symbol `species_7`.'), 'erk_inactive': ('species_11', 'native SBML value', 'ErkInactive observable. Maps to SBML symbol `species_11`.')}
