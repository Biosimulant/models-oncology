...
class Iwamoto2010CellCycleReponseToDnaDamageBiomd0000000939Model(TelluriumSBMLBioModule):
    ...
    _PARAMETER_INPUTS = {}
    _INITIAL_CONDITION_INPUTS = {'dna_damage_signal_source_parameter': ('DNA_damage_signal', 0.0, 'native SBML value', 'DNA damage signal source parameter. Maps to bundled SBML parameter `DNA_damage_signal`.'), 'initial_p27_cyclin_d_cdk4': ('p27_CyclinD_Cdk4', 0.001, 'native SBML value', 'Initial P27/CyclinD/Cdk4. Sets the initial value of bundled SBML symbol `p27_CyclinD_Cdk4`.'), 'initial_p27_cyclin_e_cdk2': ('p27_CyclinE_Cdk2', 1.0, 'native SBML value', 'Initial P27/CyclinE/Cdk2. Sets the initial value of bundled SBML symbol `p27_CyclinE_Cdk2`.'), 'initial_p27_cyclin_a_cdk2': ('p27_CyclinA_Cdk2', 0.0001, 'native SBML value', 'Initial P27/CyclinA/Cdk2. Sets the initial value of bundled SBML symbol `p27_CyclinA_Cdk2`.'), 'initial_p21_cyclin_d_cdk4': ('p21_CyclinD_Cdk4', 0.0, 'native SBML value', 'Initial P21/CyclinD/Cdk4. Sets the initial value of bundled SBML symbol `p21_CyclinD_Cdk4`.'), 'initial_p21_cyclin_e_cdk2': ('p21_CyclinE_Cdk2', 0.0, 'native SBML value', 'Initial P21/CyclinE/Cdk2. Sets the initial value of bundled SBML symbol `p21_CyclinE_Cdk2`.')}
    _HEADLINE_OUTPUTS = {'p27_cyclin_d_cdk4': ('p27_CyclinD_Cdk4', 'native SBML value', 'P27/CyclinD/Cdk4 observable. Maps to SBML symbol `p27_CyclinD_Cdk4`.'), 'p27_cyclin_e_cdk2': ('p27_CyclinE_Cdk2', 'native SBML value', 'P27/CyclinE/Cdk2 observable. Maps to SBML symbol `p27_CyclinE_Cdk2`.'), 'p27_cyclin_a_cdk2': ('p27_CyclinA_Cdk2', 'native SBML value', 'P27/CyclinA/Cdk2 observable. Maps to SBML symbol `p27_CyclinA_Cdk2`.'), 'p21_cyclin_d_cdk4': ('p21_CyclinD_Cdk4', 'native SBML value', 'P21/CyclinD/Cdk4 observable. Maps to SBML symbol `p21_CyclinD_Cdk4`.'), 'p21_cyclin_e_cdk2': ('p21_CyclinE_Cdk2', 'native SBML value', 'P21/CyclinE/Cdk2 observable. Maps to SBML symbol `p21_CyclinE_Cdk2`.'), 'p21_cyclin_a_cdk2': ('p21_CyclinA_Cdk2', 'native SBML value', 'P21/CyclinA/Cdk2 observable. Maps to SBML symbol `p21_CyclinA_Cdk2`.')}
