...
"""Tellurium-backed SBML wrapper for Gevertz2018 - Cancer Treatment with Oncolytic Viruses and Dendritic Cell injections original model."""
...
class Gevertz2018CancerTreatmentWithOncolyticViruBiomd0000000816Model(TelluriumSBMLBioModule):
    """Faithful wrapper around the bundled SBML source file."""

    _SBML_ID = 'BIOMD0000000816'
    _TITLE = 'Gevertz2018 - Cancer Treatment with Oncolytic Viruses and Dendritic Cell injections original model'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000816.xml', integration_step: float = 0.1) -> None:
