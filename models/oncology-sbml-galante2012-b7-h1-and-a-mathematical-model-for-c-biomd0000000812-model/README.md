...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000812)
**Standard**: sbml
**Authors**: Amanda Galante; Koji Tamada; Doron Levy
...
models:
  - path: ../../models/oncology-sbml-galante2012-b7-h1-and-a-mathematical-model-for-c-biomd0000000812-model
    alias: model
```
