...
"""Auto-generated SBML BioModule wrapper for Galante2012 - B7-H1 and a Mathematical Model for Cytotoxic T Cell and Tumor Cell Interaction.

Source: biomodels_ebi:BIOMD0000000812
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000812
"""
...
class SbmlGalante2012B7H1AndAMathematicalModelForCytotoxicT(biosim.BioModule):
    """BioModule wrapper for SBML model: Galante2012 - B7-H1 and a Mathematical Model for Cytotoxic T Cell and Tumor Cell Interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000812.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Galante2012B7H1AndAMathematicalModelForCBiomd0000000812Model = SbmlGalante2012B7H1AndAMathematicalModelForCytotoxicT
