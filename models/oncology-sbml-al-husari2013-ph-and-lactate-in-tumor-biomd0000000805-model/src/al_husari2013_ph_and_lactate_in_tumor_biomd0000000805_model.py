...
"""Auto-generated SBML BioModule wrapper for Al-Husari2013 - pH and lactate in tumor.

Source: biomodels_ebi:BIOMD0000000805
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000805
"""
...
class SbmlAlHusari2013PhAndLactateInTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Al-Husari2013 - pH and lactate in tumor."""

    def __init__(self, model_path: str = "data/BIOMD0000000805.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AlHusari2013PhAndLactateInTumorBiomd0000000805Model = SbmlAlHusari2013PhAndLactateInTumor
