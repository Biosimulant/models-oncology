...
"""Auto-generated SBML BioModule wrapper for Ribba2018 - Mathematical Model of Tumor Uptake for Immunocytokine-Based Cancer Immunotherapy.

Source: biomodels_ebi:MODEL1909050002
Original: https://www.ebi.ac.uk/biomodels/MODEL1909050002
"""
...
class SbmlRibba2018MathematicalModelOfTumorUptakeFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Ribba2018 - Mathematical Model of Tumor Uptake for Immunocytokine-Based Cancer Immunotherapy."""

    def __init__(self, model_path: str = "data/MODEL1909050002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ribba2018MathematicalModelOfTumorUptakeForModel1909050002Model = SbmlRibba2018MathematicalModelOfTumorUptakeFor
