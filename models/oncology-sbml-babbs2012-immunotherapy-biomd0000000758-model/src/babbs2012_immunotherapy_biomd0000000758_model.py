...
"""Auto-generated SBML BioModule wrapper for Babbs2012 - immunotherapy.

Source: biomodels_ebi:BIOMD0000000758
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000758
"""
...
class SbmlBabbs2012Immunotherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Babbs2012 - immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000758.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Babbs2012ImmunotherapyBiomd0000000758Model = SbmlBabbs2012Immunotherapy
