...
"""Auto-generated SBML BioModule wrapper for Malinzi2018 - Enhancement of chemotherapy using oncolytic virotherapy.

Source: biomodels_ebi:MODEL2003050002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003050002
"""
...
class SbmlMalinzi2018EnhancementOfChemotherapyUsingOncolytic(biosim.BioModule):
    """BioModule wrapper for SBML model: Malinzi2018 - Enhancement of chemotherapy using oncolytic virotherapy."""

    def __init__(self, model_path: str = "data/MODEL2003050002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Malinzi2018EnhancementOfChemotherapyUsingOnModel2003050002Model = SbmlMalinzi2018EnhancementOfChemotherapyUsingOncolytic
