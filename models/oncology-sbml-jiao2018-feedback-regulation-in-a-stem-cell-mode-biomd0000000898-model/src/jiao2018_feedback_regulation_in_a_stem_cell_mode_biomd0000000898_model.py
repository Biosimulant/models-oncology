...
"""Auto-generated SBML BioModule wrapper for Jiao2018 - Feedback regulation in a stem cell model with acute myeloid leukaemia.

Source: biomodels_ebi:BIOMD0000000898
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000898
"""
...
class SbmlJiao2018FeedbackRegulationInAStemCellModelWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Jiao2018 - Feedback regulation in a stem cell model with acute myeloid leukaemia."""

    def __init__(self, model_path: str = "data/BIOMD0000000898.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jiao2018FeedbackRegulationInAStemCellModeBiomd0000000898Model = SbmlJiao2018FeedbackRegulationInAStemCellModelWith
