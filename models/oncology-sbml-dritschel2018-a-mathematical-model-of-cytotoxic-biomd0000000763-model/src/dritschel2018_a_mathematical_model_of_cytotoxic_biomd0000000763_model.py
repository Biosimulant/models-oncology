...
"""Auto-generated SBML BioModule wrapper for Dritschel2018 - A mathematical model of cytotoxic and helper T cell interactions in a tumour microenvironment.

Source: biomodels_ebi:BIOMD0000000763
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000763
"""
...
class SbmlDritschel2018AMathematicalModelOfCytotoxicAndHelper(biosim.BioModule):
    """BioModule wrapper for SBML model: Dritschel2018 - A mathematical model of cytotoxic and helper T cell interactions in a tumour microenvironment."""

    def __init__(self, model_path: str = "data/BIOMD0000000763.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dritschel2018AMathematicalModelOfCytotoxicBiomd0000000763Model = SbmlDritschel2018AMathematicalModelOfCytotoxicAndHelper
