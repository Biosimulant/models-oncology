...
"""Auto-generated SBML BioModule wrapper for dePillis2008 - Optimal control of mixed immunotherapy and chemotherapy of tumors.

Source: biomodels_ebi:BIOMD0000000913
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000913
"""
...
class SbmlDepillis2008OptimalControlOfMixedImmunotherapyAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2008 - Optimal control of mixed immunotherapy and chemotherapy of tumors."""

    def __init__(self, model_path: str = "data/BIOMD0000000913.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2008OptimalControlOfMixedImmunotherBiomd0000000913Model = SbmlDepillis2008OptimalControlOfMixedImmunotherapyAnd
