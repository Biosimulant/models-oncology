...
"""Auto-generated SBML BioModule wrapper for Raia2010 - IL13 Signalling MedB1.

Source: biomodels_ebi:BIOMD0000000313
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000313
"""
...
class SbmlRaia2010Il13SignallingMedb1(biosim.BioModule):
    """BioModule wrapper for SBML model: Raia2010 - IL13 Signalling MedB1."""

    def __init__(self, model_path: str = "data/BIOMD0000000313.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Raia2010Il13SignallingMedb1Biomd0000000313Model = SbmlRaia2010Il13SignallingMedb1
