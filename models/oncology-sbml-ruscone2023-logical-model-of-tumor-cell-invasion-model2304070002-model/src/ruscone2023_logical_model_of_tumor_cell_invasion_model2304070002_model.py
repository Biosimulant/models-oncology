...
"""Auto-generated SBML BioModule wrapper for Ruscone2023 - Logical model of Tumor Cell Invasion.

Source: biomodels_ebi:MODEL2304070002
Original: https://www.ebi.ac.uk/biomodels/MODEL2304070002
"""
...
class SbmlRuscone2023LogicalModelOfTumorCellInvasion(biosim.BioModule):
    """BioModule wrapper for SBML model: Ruscone2023 - Logical model of Tumor Cell Invasion."""

    def __init__(self, model_path: str = "data/MODEL2304070002.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ruscone2023LogicalModelOfTumorCellInvasionModel2304070002Model = SbmlRuscone2023LogicalModelOfTumorCellInvasion
