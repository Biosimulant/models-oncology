...
"""Auto-generated SBML BioModule wrapper for Jenner2018 - treatment of oncolytic virus.

Source: biomodels_ebi:BIOMD0000000789
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000789
"""
...
class SbmlJenner2018TreatmentOfOncolyticVirus(biosim.BioModule):
    """BioModule wrapper for SBML model: Jenner2018 - treatment of oncolytic virus."""

    def __init__(self, model_path: str = "data/BIOMD0000000789.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jenner2018TreatmentOfOncolyticVirusBiomd0000000789Model = SbmlJenner2018TreatmentOfOncolyticVirus
