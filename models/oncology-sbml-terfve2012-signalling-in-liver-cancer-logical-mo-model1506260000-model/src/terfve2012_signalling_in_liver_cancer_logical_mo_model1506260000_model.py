...
"""Auto-generated SBML BioModule wrapper for Terfve2012 - Signalling in liver cancer - logical model.

Source: biomodels_ebi:MODEL1506260000
Original: https://www.ebi.ac.uk/biomodels/MODEL1506260000
"""
...
class SbmlTerfve2012SignallingInLiverCancerLogicalModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Terfve2012 - Signalling in liver cancer - logical model."""

    def __init__(self, model_path: str = "data/MODEL1506260000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Terfve2012SignallingInLiverCancerLogicalMoModel1506260000Model = SbmlTerfve2012SignallingInLiverCancerLogicalModel
