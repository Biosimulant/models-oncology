...
"""Auto-generated SBML BioModule wrapper for Claret2009 - Predicting phase III overall survival in colorectal cancer.

Source: biomodels_ebi:MODEL1708310001
Original: https://www.ebi.ac.uk/biomodels/MODEL1708310001
"""
...
class SbmlClaret2009PredictingPhaseIiiOverallSurvivalIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Claret2009 - Predicting phase III overall survival in colorectal cancer."""

    def __init__(self, model_path: str = "data/MODEL1708310001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Claret2009PredictingPhaseIiiOverallSurvivalModel1708310001Model = SbmlClaret2009PredictingPhaseIiiOverallSurvivalIn
