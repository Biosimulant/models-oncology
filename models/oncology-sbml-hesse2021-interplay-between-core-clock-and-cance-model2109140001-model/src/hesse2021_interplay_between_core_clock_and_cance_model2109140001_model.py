...
"""Auto-generated SBML BioModule wrapper for Hesse2021 - Interplay between core-clock and cancer drug irinotecan pharmacokinetics and -dynamics.

Source: biomodels_ebi:MODEL2109140001
Original: https://www.ebi.ac.uk/biomodels/MODEL2109140001
"""
...
class SbmlHesse2021InterplayBetweenCoreClockAndCancerDrug(biosim.BioModule):
    """BioModule wrapper for SBML model: Hesse2021 - Interplay between core-clock and cancer drug irinotecan pharmacokinetics and -dynamics."""

    def __init__(self, model_path: str = "data/MODEL2109140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hesse2021InterplayBetweenCoreClockAndCanceModel2109140001Model = SbmlHesse2021InterplayBetweenCoreClockAndCancerDrug
