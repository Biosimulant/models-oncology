...
"""Auto-generated SBML BioModule wrapper for Chakrabarty2010 - A control theory approach to cancer remission aided by an optimal therapy.

Source: biomodels_ebi:BIOMD0000000777
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000777
"""
...
class SbmlChakrabarty2010AControlTheoryApproachToCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Chakrabarty2010 - A control theory approach to cancer remission aided by an optimal therapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000777.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chakrabarty2010AControlTheoryApproachToCanBiomd0000000777Model = SbmlChakrabarty2010AControlTheoryApproachToCancer
