...
"""Auto-generated SBML BioModule wrapper for Murphy2016 - Differences in predictions of ODE models of tumor growth.

Source: biomodels_ebi:BIOMD0000000671
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000671
"""
...
class SbmlMurphy2016DifferencesInPredictionsOfOdeModelsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Murphy2016 - Differences in predictions of ODE models of tumor growth."""

    def __init__(self, model_path: str = "data/BIOMD0000000671.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Murphy2016DifferencesInPredictionsOfOdeModBiomd0000000671Model = SbmlMurphy2016DifferencesInPredictionsOfOdeModelsOf
