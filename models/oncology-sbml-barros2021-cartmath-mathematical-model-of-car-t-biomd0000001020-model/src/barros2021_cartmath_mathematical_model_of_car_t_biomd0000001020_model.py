...
"""Auto-generated SBML BioModule wrapper for Barros2021 - CARTmath, Mathematical Model of CAR-T Immunotherapy in Raji Cell Line.

Source: biomodels_ebi:BIOMD0000001020
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001020
"""
...
class SbmlBarros2021CartmathMathematicalModelOfCarT2(biosim.BioModule):
    """BioModule wrapper for SBML model: Barros2021 - CARTmath, Mathematical Model of CAR-T Immunotherapy in Raji Cell Line."""

    def __init__(self, model_path: str = "data/BIOMD0000001020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Barros2021CartmathMathematicalModelOfCarTBiomd0000001020Model = SbmlBarros2021CartmathMathematicalModelOfCarT2
