...
"""Auto-generated SBML BioModule wrapper for Boer1986 - Interactions between Macrophages and T-lymphocytes: Tumor Sneaking Through Intrinsic to Helper T cell Dynamics.

Source: biomodels_ebi:MODEL1912110001
Original: https://www.ebi.ac.uk/biomodels/MODEL1912110001
"""
...
class SbmlBoer1986InteractionsBetweenMacrophagesAndTLymphocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Boer1986 - Interactions between Macrophages and T-lymphocytes: Tumor Sneaking Through Intrinsic to Helper T cell Dynamics."""

    def __init__(self, model_path: str = "data/MODEL1912110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Boer1986InteractionsBetweenMacrophagesAndTModel1912110001Model = SbmlBoer1986InteractionsBetweenMacrophagesAndTLymphocytes
