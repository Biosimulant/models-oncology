...
"""Auto-generated SBML BioModule wrapper for Li2021 - HDAC3i-Finder: A Machine Learning-based Computational Tool to Screen for HDAC3 Inhibitors.

Source: biomodels_ebi:MODEL2406210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2406210001
"""
...
class SbmlLi2021Hdac3iFinderAMachineLearningBasedComputational(bsim.BioModule):
    ...
    def __init__(self, model_path: str = "data/MODEL2406210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2021Hdac3iFinderAMachineLearningBasedCoModel2406210001Model = SbmlLi2021Hdac3iFinderAMachineLearningBasedComputational
