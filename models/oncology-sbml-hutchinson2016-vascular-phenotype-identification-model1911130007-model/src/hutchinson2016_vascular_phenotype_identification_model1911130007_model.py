...
"""Auto-generated SBML BioModule wrapper for Hutchinson2016 - Vascular phenotype identification and anti-angiogenic treatment recommendation.

Source: biomodels_ebi:MODEL1911130007
Original: https://www.ebi.ac.uk/biomodels/MODEL1911130007
"""
...
class SbmlHutchinson2016VascularPhenotypeIdentificationAndAnti(biosim.BioModule):
    """BioModule wrapper for SBML model: Hutchinson2016 - Vascular phenotype identification and anti-angiogenic treatment recommendation."""

    def __init__(self, model_path: str = "data/MODEL1911130007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hutchinson2016VascularPhenotypeIdentificationModel1911130007Model = SbmlHutchinson2016VascularPhenotypeIdentificationAndAnti
