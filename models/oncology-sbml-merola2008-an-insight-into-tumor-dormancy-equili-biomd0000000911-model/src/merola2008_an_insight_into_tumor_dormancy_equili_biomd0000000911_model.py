...
"""Auto-generated SBML BioModule wrapper for Merola2008 - An insight into tumor dormancy equilibrium via the analysis of its domain of attraction.

Source: biomodels_ebi:BIOMD0000000911
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000911
"""
...
class SbmlMerola2008AnInsightIntoTumorDormancyEquilibriumVia(biosim.BioModule):
    """BioModule wrapper for SBML model: Merola2008 - An insight into tumor dormancy equilibrium via the analysis of its domain of attraction."""

    def __init__(self, model_path: str = "data/BIOMD0000000911.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Merola2008AnInsightIntoTumorDormancyEquiliBiomd0000000911Model = SbmlMerola2008AnInsightIntoTumorDormancyEquilibriumVia
