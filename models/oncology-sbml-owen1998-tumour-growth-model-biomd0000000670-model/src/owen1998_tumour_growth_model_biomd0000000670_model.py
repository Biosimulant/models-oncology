...
"""Auto-generated SBML BioModule wrapper for Owen1998 - tumour growth model.

Source: biomodels_ebi:BIOMD0000000670
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000670
"""
...
class SbmlOwen1998TumourGrowthModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Owen1998 - tumour growth model."""

    def __init__(self, model_path: str = "data/BIOMD0000000670.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Owen1998TumourGrowthModelBiomd0000000670Model = SbmlOwen1998TumourGrowthModel
