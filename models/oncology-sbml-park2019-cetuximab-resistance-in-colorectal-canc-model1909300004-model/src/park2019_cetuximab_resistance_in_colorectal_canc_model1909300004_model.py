...
"""Auto-generated SBML BioModule wrapper for Park2019 - Cetuximab resistance in colorectal cancer.

Source: biomodels_ebi:MODEL1909300004
Original: https://www.ebi.ac.uk/biomodels/MODEL1909300004
"""
...
class SbmlPark2019CetuximabResistanceInColorectalCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Park2019 - Cetuximab resistance in colorectal cancer."""

    def __init__(self, model_path: str = "data/MODEL1909300004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Park2019CetuximabResistanceInColorectalCancModel1909300004Model = SbmlPark2019CetuximabResistanceInColorectalCancer
