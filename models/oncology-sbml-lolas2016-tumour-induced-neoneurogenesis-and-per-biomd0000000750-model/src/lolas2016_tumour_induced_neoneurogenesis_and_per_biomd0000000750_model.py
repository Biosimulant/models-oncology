...
"""Auto-generated SBML BioModule wrapper for Lolas2016 - tumour-induced neoneurogenesis and perineural tumour growth.

Source: biomodels_ebi:BIOMD0000000750
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000750
"""
...
class SbmlLolas2016TumourInducedNeoneurogenesisAndPerineural(biosim.BioModule):
    """BioModule wrapper for SBML model: Lolas2016 - tumour-induced neoneurogenesis and perineural tumour growth."""

    def __init__(self, model_path: str = "data/BIOMD0000000750.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lolas2016TumourInducedNeoneurogenesisAndPerBiomd0000000750Model = SbmlLolas2016TumourInducedNeoneurogenesisAndPerineural
