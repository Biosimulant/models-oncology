...
"""Auto-generated SBML BioModule wrapper for Jenner2019 - Oncolytic virotherapy for tumours following a Gompertz growth law.

Source: biomodels_ebi:BIOMD0000000850
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000850
"""
...
class SbmlJenner2019OncolyticVirotherapyForTumoursFollowingA(biosim.BioModule):
    """BioModule wrapper for SBML model: Jenner2019 - Oncolytic virotherapy for tumours following a Gompertz growth law."""

    def __init__(self, model_path: str = "data/BIOMD0000000850.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jenner2019OncolyticVirotherapyForTumoursFolBiomd0000000850Model = SbmlJenner2019OncolyticVirotherapyForTumoursFollowingA
