...
"""Auto-generated SBML BioModule wrapper for Fassoni2019 - Oncogenesis encompassing mutations and genetic instability.

Source: biomodels_ebi:BIOMD0000000807
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000807
"""
...
class SbmlFassoni2019OncogenesisEncompassingMutationsAndGenetic(biosim.BioModule):
    """BioModule wrapper for SBML model: Fassoni2019 - Oncogenesis encompassing mutations and genetic instability."""

    def __init__(self, model_path: str = "data/BIOMD0000000807.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fassoni2019OncogenesisEncompassingMutationsABiomd0000000807Model = SbmlFassoni2019OncogenesisEncompassingMutationsAndGenetic
