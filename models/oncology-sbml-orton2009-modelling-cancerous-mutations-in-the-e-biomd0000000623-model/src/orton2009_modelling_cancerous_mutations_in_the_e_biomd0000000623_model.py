...
"""Auto-generated SBML BioModule wrapper for Orton2009 - Modelling cancerous mutations in the EGFR/ERK pathway - EGF Model.

Source: biomodels_ebi:BIOMD0000000623
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000623
"""
...
class SbmlOrton2009ModellingCancerousMutationsInTheEgfrErk(biosim.BioModule):
    """BioModule wrapper for SBML model: Orton2009 - Modelling cancerous mutations in the EGFR/ERK pathway - EGF Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000623.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Orton2009ModellingCancerousMutationsInTheEBiomd0000000623Model = SbmlOrton2009ModellingCancerousMutationsInTheEgfrErk
