...
"""Auto-generated SBML BioModule wrapper for Mpekris2017 - Role of vascular normalization in benefit from metronomic chemotherapy.

Source: biomodels_ebi:MODEL2001200002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001200002
"""
...
class SbmlMpekris2017RoleOfVascularNormalizationInBenefitFrom(biosim.BioModule):
    """BioModule wrapper for SBML model: Mpekris2017 - Role of vascular normalization in benefit from metronomic chemotherapy."""

    def __init__(self, model_path: str = "data/MODEL2001200002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mpekris2017RoleOfVascularNormalizationInBeModel2001200002Model = SbmlMpekris2017RoleOfVascularNormalizationInBenefitFrom
