...
"""Auto-generated SBML BioModule wrapper for dePillis2013 - Mathematical modeling of regulatory T cell effects on renal cell carcinoma treatment.

Source: biomodels_ebi:BIOMD0000000908
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000908
"""
...
class SbmlDepillis2013MathematicalModelingOfRegulatoryTCell(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2013 - Mathematical modeling of regulatory T cell effects on renal cell carcinoma treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000908.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2013MathematicalModelingOfRegulatoryBiomd0000000908Model = SbmlDepillis2013MathematicalModelingOfRegulatoryTCell
