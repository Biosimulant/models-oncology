...
"""Auto-generated SBML BioModule wrapper for Riya 2024 - Interplay between the immunologic network, inflammasome, and autophagy in non-small cell lung cancer (NSCLC)..

Source: biomodels_ebi:MODEL2402030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2402030002
"""
...
class SbmlRiya2024InterplayBetweenTheImmunologicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Riya 2024 - Interplay between the immunologic network, inflammasome, and autophagy in non-small cell lung cancer (NSCLC).."""

    def __init__(self, model_path: str = "data/MODEL2402030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Riya2024InterplayBetweenTheImmunologicNetwModel2402030002Model = SbmlRiya2024InterplayBetweenTheImmunologicNetwork
