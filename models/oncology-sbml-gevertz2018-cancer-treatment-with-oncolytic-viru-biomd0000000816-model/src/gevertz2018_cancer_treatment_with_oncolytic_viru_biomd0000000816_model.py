...
"""Auto-generated SBML BioModule wrapper for Gevertz2018 - Cancer Treatment with Oncolytic Viruses and Dendritic Cell injections original model.

Source: biomodels_ebi:BIOMD0000000816
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000816
"""
...
class SbmlGevertz2018CancerTreatmentWithOncolyticVirusesAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Gevertz2018 - Cancer Treatment with Oncolytic Viruses and Dendritic Cell injections original model."""

    def __init__(self, model_path: str = "data/BIOMD0000000816.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gevertz2018CancerTreatmentWithOncolyticViruBiomd0000000816Model = SbmlGevertz2018CancerTreatmentWithOncolyticVirusesAnd
