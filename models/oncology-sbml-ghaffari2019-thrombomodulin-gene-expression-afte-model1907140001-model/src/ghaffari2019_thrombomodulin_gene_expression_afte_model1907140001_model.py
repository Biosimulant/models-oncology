...
"""Auto-generated SBML BioModule wrapper for Ghaffari2019 - Thrombomodulin Gene Expression after Retinoic Acid Treatment for Cancer Patients with Coagulation Disorders.

Source: biomodels_ebi:MODEL1907140001
Original: https://www.ebi.ac.uk/biomodels/MODEL1907140001
"""
...
class SbmlGhaffari2019ThrombomodulinGeneExpressionAfterRetinoic(biosim.BioModule):
    """BioModule wrapper for SBML model: Ghaffari2019 - Thrombomodulin Gene Expression after Retinoic Acid Treatment for Cancer Patients with Coagulation Disorders."""

    def __init__(self, model_path: str = "data/MODEL1907140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ghaffari2019ThrombomodulinGeneExpressionAfteModel1907140001Model = SbmlGhaffari2019ThrombomodulinGeneExpressionAfterRetinoic
