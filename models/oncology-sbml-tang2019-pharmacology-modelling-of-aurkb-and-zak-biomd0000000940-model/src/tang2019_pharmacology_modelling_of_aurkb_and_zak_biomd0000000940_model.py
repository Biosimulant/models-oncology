...
"""Auto-generated SBML BioModule wrapper for Tang2019 - Pharmacology modelling of AURKB and ZAK interaction in TNBC.

Source: biomodels_ebi:BIOMD0000000940
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000940
"""
...
class SbmlTang2019PharmacologyModellingOfAurkbAndZak(biosim.BioModule):
    """BioModule wrapper for SBML model: Tang2019 - Pharmacology modelling of AURKB and ZAK interaction in TNBC."""

    def __init__(self, model_path: str = "data/BIOMD0000000940.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tang2019PharmacologyModellingOfAurkbAndZakBiomd0000000940Model = SbmlTang2019PharmacologyModellingOfAurkbAndZak
