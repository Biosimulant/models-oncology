...
"""Auto-generated SBML BioModule wrapper for Solis-perez2019 - A fractional mathematical model of breast cancer competition model.

Source: biomodels_ebi:BIOMD0000000903
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000903
"""
...
class SbmlSolisPerez2019AFractionalMathematicalModelOfBreast(biosim.BioModule):
    """BioModule wrapper for SBML model: Solis-perez2019 - A fractional mathematical model of breast cancer competition model."""

    def __init__(self, model_path: str = "data/BIOMD0000000903.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SolisPerez2019AFractionalMathematicalModelBiomd0000000903Model = SbmlSolisPerez2019AFractionalMathematicalModelOfBreast
