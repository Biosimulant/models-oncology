...
"""Auto-generated SBML BioModule wrapper for Yazdjer2019 - reinforcement learning-based control of tumor growth under anti-angiogenic therapy.

Source: biomodels_ebi:BIOMD0000000821
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000821
"""
...
class SbmlYazdjer2019ReinforcementLearningBasedControlOfTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Yazdjer2019 - reinforcement learning-based control of tumor growth under anti-angiogenic therapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000821.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yazdjer2019ReinforcementLearningBasedControlBiomd0000000821Model = SbmlYazdjer2019ReinforcementLearningBasedControlOfTumor
