...
"""Auto-generated SBML BioModule wrapper for Ribba2012 - Low-grade gliomas, tumour growth inhibition model.

Source: biomodels_ebi:BIOMD0000000521
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000521
"""
...
class SbmlRibba2012LowGradeGliomasTumourGrowthInhibitionModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Ribba2012 - Low-grade gliomas, tumour growth inhibition model."""

    def __init__(self, model_path: str = "data/BIOMD0000000521.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ribba2012LowGradeGliomasTumourGrowthInhibiBiomd0000000521Model = SbmlRibba2012LowGradeGliomasTumourGrowthInhibitionModel
