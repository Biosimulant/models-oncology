...
"""Auto-generated SBML BioModule wrapper for Zeilfelder2025 - Model for human liver cancer cell line HepG2.

Source: biomodels_ebi:MODEL2503270001
Original: https://www.ebi.ac.uk/biomodels/MODEL2503270001
"""
...
class SbmlZeilfelder2025ModelForHumanLiverCancerCellLineHepg2(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeilfelder2025 - Model for human liver cancer cell line HepG2."""

    def __init__(self, model_path: str = "data/MODEL2503270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeilfelder2025ModelForHumanLiverCancerCellModel2503270001Model = SbmlZeilfelder2025ModelForHumanLiverCancerCellLineHepg2
