...
"""Auto-generated SBML BioModule wrapper for Kronik2010 - Predicting Outcomes of Prostate Cancer Immunotherapyby Personalized Mathematical Models.

Source: biomodels_ebi:MODEL2001130003
Original: https://www.ebi.ac.uk/biomodels/MODEL2001130003
"""
...
class SbmlKronik2010PredictingOutcomesOfProstateCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Kronik2010 - Predicting Outcomes of Prostate Cancer Immunotherapyby Personalized Mathematical Models."""

    def __init__(self, model_path: str = "data/MODEL2001130003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kronik2010PredictingOutcomesOfProstateCanceModel2001130003Model = SbmlKronik2010PredictingOutcomesOfProstateCancer
