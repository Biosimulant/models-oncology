...
"""Auto-generated SBML BioModule wrapper for Shin_2018_EGFR-PYK2-c-Met interaction network_model.

Source: biomodels_ebi:BIOMD0000000826
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000826
"""
...
class SbmlShin2018EgfrPyk2CMetInteractionNetworkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Shin_2018_EGFR-PYK2-c-Met interaction network_model."""

    def __init__(self, model_path: str = "data/BIOMD0000000826.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shin2018EgfrPyk2CMetInteractionNetworkMoBiomd0000000826Model = SbmlShin2018EgfrPyk2CMetInteractionNetworkModel
