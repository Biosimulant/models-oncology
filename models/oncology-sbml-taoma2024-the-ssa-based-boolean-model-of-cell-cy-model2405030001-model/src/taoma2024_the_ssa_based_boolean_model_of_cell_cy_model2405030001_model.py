...
"""Auto-generated SBML BioModule wrapper for Taoma2024 - The SSA-based Boolean model of cell cycle in budding yeast.

Source: biomodels_ebi:MODEL2405030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2405030001
"""
...
class SbmlTaoma2024TheSsaBasedBooleanModelOfCellCycleIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Taoma2024 - The SSA-based Boolean model of cell cycle in budding yeast."""

    def __init__(self, model_path: str = "data/MODEL2405030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Taoma2024TheSsaBasedBooleanModelOfCellCyModel2405030001Model = SbmlTaoma2024TheSsaBasedBooleanModelOfCellCycleIn
