...
"""Auto-generated SBML BioModule wrapper for Dorvash2019 - Dynamic modeling of signal transduction by mTOR complexes in cancer.

Source: biomodels_ebi:BIOMD0000000822
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000822
"""
...
class SbmlDorvash2019DynamicModelingOfSignalTransductionByMtor(biosim.BioModule):
    """BioModule wrapper for SBML model: Dorvash2019 - Dynamic modeling of signal transduction by mTOR complexes in cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000822.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dorvash2019DynamicModelingOfSignalTransductBiomd0000000822Model = SbmlDorvash2019DynamicModelingOfSignalTransductionByMtor
