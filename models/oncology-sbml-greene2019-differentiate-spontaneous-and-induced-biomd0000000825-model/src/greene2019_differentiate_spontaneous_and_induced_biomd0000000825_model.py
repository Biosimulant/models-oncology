...
"""Auto-generated SBML BioModule wrapper for Greene2019 - Differentiate Spontaneous and Induced Evolution to Drug Resistance During Cancer Treatment.

Source: biomodels_ebi:BIOMD0000000825
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000825
"""
...
class SbmlGreene2019DifferentiateSpontaneousAndInducedEvolution(biosim.BioModule):
    """BioModule wrapper for SBML model: Greene2019 - Differentiate Spontaneous and Induced Evolution to Drug Resistance During Cancer Treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000825.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Greene2019DifferentiateSpontaneousAndInducedBiomd0000000825Model = SbmlGreene2019DifferentiateSpontaneousAndInducedEvolution
