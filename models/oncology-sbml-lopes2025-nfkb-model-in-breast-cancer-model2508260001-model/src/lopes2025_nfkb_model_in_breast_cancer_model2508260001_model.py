...
"""Auto-generated SBML BioModule wrapper for Lopes2025 - NFkB model in Breast Cancer.

Source: biomodels_ebi:MODEL2508260001
Original: https://www.ebi.ac.uk/biomodels/MODEL2508260001
"""
...
class SbmlLopes2025NfkbModelInBreastCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Lopes2025 - NFkB model in Breast Cancer."""

    def __init__(self, model_path: str = "data/MODEL2508260001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lopes2025NfkbModelInBreastCancerModel2508260001Model = SbmlLopes2025NfkbModelInBreastCancer
