...
"""Auto-generated SBML BioModule wrapper for Chareyron2009 - Mixed immunotherapy and chemotherapy of tumors Feedback design and model updating schemes.

Source: biomodels_ebi:MODEL2001160002
Original: https://www.ebi.ac.uk/biomodels/MODEL2001160002
"""
...
class SbmlChareyron2009MixedImmunotherapyAndChemotherapyOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Chareyron2009 - Mixed immunotherapy and chemotherapy of tumors Feedback design and model updating schemes."""

    def __init__(self, model_path: str = "data/MODEL2001160002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chareyron2009MixedImmunotherapyAndChemotheraModel2001160002Model = SbmlChareyron2009MixedImmunotherapyAndChemotherapyOf
