...
"""Auto-generated SBML BioModule wrapper for Talemi2015 - Persistent telomere-associated DNA damage foci (TAF), a measure to predict cancer risks.

Source: biomodels_ebi:MODEL1412200000
Original: https://www.ebi.ac.uk/biomodels/MODEL1412200000
"""
...
class SbmlTalemi2015PersistentTelomereAssociatedDnaDamageFoci(biosim.BioModule):
    """BioModule wrapper for SBML model: Talemi2015 - Persistent telomere-associated DNA damage foci (TAF), a measure to predict cancer risks."""

    def __init__(self, model_path: str = "data/MODEL1412200000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Talemi2015PersistentTelomereAssociatedDnaDaModel1412200000Model = SbmlTalemi2015PersistentTelomereAssociatedDnaDamageFoci
