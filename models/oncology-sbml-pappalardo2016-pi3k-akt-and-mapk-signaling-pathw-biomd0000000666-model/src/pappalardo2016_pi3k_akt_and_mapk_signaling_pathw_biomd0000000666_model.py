...
"""Auto-generated SBML BioModule wrapper for Pappalardo2016 - PI3K/AKT and MAPK Signaling Pathways in Melanoma Cancer.

Source: biomodels_ebi:BIOMD0000000666
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000666
"""
...
class SbmlPappalardo2016Pi3kAktAndMapkSignalingPathwaysIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Pappalardo2016 - PI3K/AKT and MAPK Signaling Pathways in Melanoma Cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000666.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pappalardo2016Pi3kAktAndMapkSignalingPathwBiomd0000000666Model = SbmlPappalardo2016Pi3kAktAndMapkSignalingPathwaysIn
