...
"""Auto-generated SBML BioModule wrapper for Perez-Garcia19 - Computational design of improved standardized chemotherapy protocols for grade 2 oligodendrogliomas.

Source: biomodels_ebi:BIOMD0000000814
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000814
"""
...
class SbmlPerezGarcia19ComputationalDesignOfImproved(biosim.BioModule):
    """BioModule wrapper for SBML model: Perez-Garcia19 - Computational design of improved standardized chemotherapy protocols for grade 2 oligodendrogliomas."""

    def __init__(self, model_path: str = "data/BIOMD0000000814.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PerezGarcia19ComputationalDesignOfImprovedBiomd0000000814Model = SbmlPerezGarcia19ComputationalDesignOfImproved
