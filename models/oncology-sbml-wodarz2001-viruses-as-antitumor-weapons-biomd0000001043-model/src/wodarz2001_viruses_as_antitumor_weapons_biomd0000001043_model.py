...
"""Auto-generated SBML BioModule wrapper for Wodarz2001 - Viruses as antitumor weapons.

Source: biomodels_ebi:BIOMD0000001043
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001043
"""
...
class SbmlWodarz2001VirusesAsAntitumorWeapons(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2001 - Viruses as antitumor weapons."""

    def __init__(self, model_path: str = "data/BIOMD0000001043.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2001VirusesAsAntitumorWeaponsBiomd0000001043Model = SbmlWodarz2001VirusesAsAntitumorWeapons
