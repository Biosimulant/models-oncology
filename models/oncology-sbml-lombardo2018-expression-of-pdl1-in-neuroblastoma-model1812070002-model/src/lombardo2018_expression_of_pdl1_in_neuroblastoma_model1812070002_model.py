...
"""Auto-generated SBML BioModule wrapper for Lombardo2018 - Expression of PDL1 in Neuroblastoma Cancer Cell.

Source: biomodels_ebi:MODEL1812070002
Original: https://www.ebi.ac.uk/biomodels/MODEL1812070002
"""
...
class SbmlLombardo2018ExpressionOfPdl1InNeuroblastomaCancerCell(biosim.BioModule):
    """BioModule wrapper for SBML model: Lombardo2018 - Expression of PDL1 in Neuroblastoma Cancer Cell."""

    def __init__(self, model_path: str = "data/MODEL1812070002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lombardo2018ExpressionOfPdl1InNeuroblastomaModel1812070002Model = SbmlLombardo2018ExpressionOfPdl1InNeuroblastomaCancerCell
