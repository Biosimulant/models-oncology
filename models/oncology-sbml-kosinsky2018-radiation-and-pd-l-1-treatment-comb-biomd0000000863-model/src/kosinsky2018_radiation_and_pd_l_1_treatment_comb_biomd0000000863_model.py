...
"""Auto-generated SBML BioModule wrapper for Kosinsky2018 - Radiation and PD-(L)1 treatment combinations.

Source: biomodels_ebi:BIOMD0000000863
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000863
"""
...
class SbmlKosinsky2018RadiationAndPdL1TreatmentCombinations(biosim.BioModule):
    """BioModule wrapper for SBML model: Kosinsky2018 - Radiation and PD-(L)1 treatment combinations."""

    def __init__(self, model_path: str = "data/BIOMD0000000863.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kosinsky2018RadiationAndPdL1TreatmentCombBiomd0000000863Model = SbmlKosinsky2018RadiationAndPdL1TreatmentCombinations
