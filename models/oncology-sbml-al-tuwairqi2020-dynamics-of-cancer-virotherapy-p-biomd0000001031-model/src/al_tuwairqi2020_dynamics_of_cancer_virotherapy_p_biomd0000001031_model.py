...
"""Auto-generated SBML BioModule wrapper for Al-Tuwairqi2020 - Dynamics of cancer virotherapy - Phase I treatment.

Source: biomodels_ebi:BIOMD0000001031
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001031
"""
...
class SbmlAlTuwairqi2020DynamicsOfCancerVirotherapyPhaseI(biosim.BioModule):
    """BioModule wrapper for SBML model: Al-Tuwairqi2020 - Dynamics of cancer virotherapy - Phase I treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000001031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AlTuwairqi2020DynamicsOfCancerVirotherapyPBiomd0000001031Model = SbmlAlTuwairqi2020DynamicsOfCancerVirotherapyPhaseI
