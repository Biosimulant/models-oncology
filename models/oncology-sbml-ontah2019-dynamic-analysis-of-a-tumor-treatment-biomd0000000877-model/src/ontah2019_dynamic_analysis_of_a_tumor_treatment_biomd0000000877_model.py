...
"""Auto-generated SBML BioModule wrapper for Ontah2019 - Dynamic analysis of a tumor treatment model using oncolytic virus and chemotherapy with saturated infection rate.

Source: biomodels_ebi:BIOMD0000000877
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000877
"""
...
class SbmlOntah2019DynamicAnalysisOfATumorTreatmentModelUsing(biosim.BioModule):
    """BioModule wrapper for SBML model: Ontah2019 - Dynamic analysis of a tumor treatment model using oncolytic virus and chemotherapy with saturated infection rate."""

    def __init__(self, model_path: str = "data/BIOMD0000000877.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ontah2019DynamicAnalysisOfATumorTreatmentBiomd0000000877Model = SbmlOntah2019DynamicAnalysisOfATumorTreatmentModelUsing
