...
"""Auto-generated SBML BioModule wrapper for Capuani2015 - Human Core Catabolic Network.

Source: biomodels_ebi:MODEL1506170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1506170000
"""
...
class SbmlCapuani2015HumanCoreCatabolicNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Capuani2015 - Human Core Catabolic Network."""

    def __init__(self, model_path: str = "data/MODEL1506170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Capuani2015HumanCoreCatabolicNetworkModel1506170000Model = SbmlCapuani2015HumanCoreCatabolicNetwork
