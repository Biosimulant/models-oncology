...
"""Auto-generated SBML BioModule wrapper for Tortolina2015 - Multiple signalling pathway associated with colorectal cancer.

Source: biomodels_ebi:MODEL1601250000
Original: https://www.ebi.ac.uk/biomodels/MODEL1601250000
"""
...
class SbmlTortolina2015MultipleSignallingPathwayAssociatedWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Tortolina2015 - Multiple signalling pathway associated with colorectal cancer."""

    def __init__(self, model_path: str = "data/MODEL1601250000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tortolina2015MultipleSignallingPathwayAssociModel1601250000Model = SbmlTortolina2015MultipleSignallingPathwayAssociatedWith
