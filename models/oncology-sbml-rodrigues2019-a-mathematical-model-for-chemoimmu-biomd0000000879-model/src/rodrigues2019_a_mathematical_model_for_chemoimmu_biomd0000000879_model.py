...
"""Auto-generated SBML BioModule wrapper for Rodrigues2019 - A mathematical model for chemoimmunotherapy of chronic lymphocytic leukemia.

Source: biomodels_ebi:BIOMD0000000879
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000879
"""
...
class SbmlRodrigues2019AMathematicalModelForChemoimmunotherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodrigues2019 - A mathematical model for chemoimmunotherapy of chronic lymphocytic leukemia."""

    def __init__(self, model_path: str = "data/BIOMD0000000879.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rodrigues2019AMathematicalModelForChemoimmuBiomd0000000879Model = SbmlRodrigues2019AMathematicalModelForChemoimmunotherapy
