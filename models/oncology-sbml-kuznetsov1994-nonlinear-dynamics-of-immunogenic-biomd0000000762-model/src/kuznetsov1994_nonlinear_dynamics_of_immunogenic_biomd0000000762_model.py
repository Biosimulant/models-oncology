...
"""Auto-generated SBML BioModule wrapper for Kuznetsov1994 - Nonlinear dynamics of immunogenic tumors.

Source: biomodels_ebi:BIOMD0000000762
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000762
"""
...
class SbmlKuznetsov1994NonlinearDynamicsOfImmunogenicTumors(biosim.BioModule):
    """BioModule wrapper for SBML model: Kuznetsov1994 - Nonlinear dynamics of immunogenic tumors."""

    def __init__(self, model_path: str = "data/BIOMD0000000762.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kuznetsov1994NonlinearDynamicsOfImmunogenicBiomd0000000762Model = SbmlKuznetsov1994NonlinearDynamicsOfImmunogenicTumors
