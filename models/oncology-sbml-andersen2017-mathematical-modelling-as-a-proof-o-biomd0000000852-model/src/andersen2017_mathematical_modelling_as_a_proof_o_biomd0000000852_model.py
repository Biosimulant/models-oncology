...
"""Auto-generated SBML BioModule wrapper for Andersen2017 - Mathematical modelling as a proof of concept for MPNs as a human inflammation model for cancer development.

Source: biomodels_ebi:BIOMD0000000852
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000852
"""
...
class SbmlAndersen2017MathematicalModellingAsAProofOfConcept(biosim.BioModule):
    """BioModule wrapper for SBML model: Andersen2017 - Mathematical modelling as a proof of concept for MPNs as a human inflammation model for cancer development."""

    def __init__(self, model_path: str = "data/BIOMD0000000852.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Andersen2017MathematicalModellingAsAProofOBiomd0000000852Model = SbmlAndersen2017MathematicalModellingAsAProofOfConcept
