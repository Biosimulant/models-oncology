...
"""Auto-generated SBML BioModule wrapper for Ayush2018 - Breast Cancer Detection using SVM and WDBC Dataset.

Source: biomodels_ebi:MODEL2407130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2407130001
"""
...
class SbmlAyush2018BreastCancerDetectionUsingSvmAndWdbcDataset(biosim.BioModule):
    """BioModule wrapper for SBML model: Ayush2018 - Breast Cancer Detection using SVM and WDBC Dataset."""

    def __init__(self, model_path: str = "data/MODEL2407130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ayush2018BreastCancerDetectionUsingSvmAndModel2407130001Model = SbmlAyush2018BreastCancerDetectionUsingSvmAndWdbcDataset
