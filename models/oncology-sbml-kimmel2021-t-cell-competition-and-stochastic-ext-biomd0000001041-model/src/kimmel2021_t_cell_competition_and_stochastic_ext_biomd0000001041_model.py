...
"""Auto-generated SBML BioModule wrapper for Kimmel2021 - T cell competition and stochastic extinction events in CAR T cell therapy.

Source: biomodels_ebi:BIOMD0000001041
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001041
"""
...
class SbmlKimmel2021TCellCompetitionAndStochasticExtinction(biosim.BioModule):
    """BioModule wrapper for SBML model: Kimmel2021 - T cell competition and stochastic extinction events in CAR T cell therapy."""

    def __init__(self, model_path: str = "data/BIOMD0000001041.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kimmel2021TCellCompetitionAndStochasticExtBiomd0000001041Model = SbmlKimmel2021TCellCompetitionAndStochasticExtinction
