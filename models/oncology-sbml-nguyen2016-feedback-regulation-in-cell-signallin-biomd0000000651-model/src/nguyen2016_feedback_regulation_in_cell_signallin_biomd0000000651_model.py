...
"""Auto-generated SBML BioModule wrapper for Nguyen2016 - Feedback regulation in cell signalling: Lessons for cancer therapeutics.

Source: biomodels_ebi:BIOMD0000000651
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000651
"""
...
class SbmlNguyen2016FeedbackRegulationInCellSignallingLessons(biosim.BioModule):
    """BioModule wrapper for SBML model: Nguyen2016 - Feedback regulation in cell signalling: Lessons for cancer therapeutics."""

    def __init__(self, model_path: str = "data/BIOMD0000000651.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nguyen2016FeedbackRegulationInCellSignallinBiomd0000000651Model = SbmlNguyen2016FeedbackRegulationInCellSignallingLessons
