...
"""Auto-generated SBML BioModule wrapper for Bianconi2012 - EGFR and IGF1R pathway in lung cancer.

Source: biomodels_ebi:BIOMD0000000427
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000427
"""
...
class SbmlBianconi2012EgfrAndIgf1rPathwayInLungCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Bianconi2012 - EGFR and IGF1R pathway in lung cancer."""

    def __init__(self, model_path: str = "data/BIOMD0000000427.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bianconi2012EgfrAndIgf1rPathwayInLungCancBiomd0000000427Model = SbmlBianconi2012EgfrAndIgf1rPathwayInLungCancer
