...
"""Auto-generated SBML BioModule wrapper for Bordel2018 - GSMM for Human Metabolic Reactions (HMR database).

Source: biomodels_ebi:MODEL1707250000
Original: https://www.ebi.ac.uk/biomodels/MODEL1707250000
"""
...
class SbmlBordel2018GsmmForHumanMetabolicReactionsHmrDatabase(biosim.BioModule):
    """BioModule wrapper for SBML model: Bordel2018 - GSMM for Human Metabolic Reactions (HMR database)."""

    def __init__(self, model_path: str = "data/MODEL1707250000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bordel2018GsmmForHumanMetabolicReactionsHmModel1707250000Model = SbmlBordel2018GsmmForHumanMetabolicReactionsHmrDatabase
