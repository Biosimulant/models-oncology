...
"""Auto-generated SBML BioModule wrapper for Al-Tuwairqi2020 - Dynamics of cancer radiovirotherapy - Phase II treatment.

Source: biomodels_ebi:BIOMD0000001032
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001032
"""
...
class SbmlAlTuwairqi2020DynamicsOfCancerRadiovirotherapyPhase(biosim.BioModule):
    """BioModule wrapper for SBML model: Al-Tuwairqi2020 - Dynamics of cancer radiovirotherapy - Phase II treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000001032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AlTuwairqi2020DynamicsOfCancerRadiovirotherBiomd0000001032Model = SbmlAlTuwairqi2020DynamicsOfCancerRadiovirotherapyPhase
