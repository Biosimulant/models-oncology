...
"""Auto-generated SBML BioModule wrapper for Li2016 - Model for pancreatic cancer patients receiving immunotherapy.

Source: biomodels_ebi:BIOMD0000000929
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000929
"""
...
class SbmlLi2016ModelForPancreaticCancerPatientsReceiving(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2016 - Model for pancreatic cancer patients receiving immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000929.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2016ModelForPancreaticCancerPatientsReceBiomd0000000929Model = SbmlLi2016ModelForPancreaticCancerPatientsReceiving
