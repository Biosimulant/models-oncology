...
"""Auto-generated SBML BioModule wrapper for Bouchnita2019 - A multiscale model to design therapeutic strategies that overcome drug resistance to tyrosine kinase inhibitors in multiple myeloma.

Source: biomodels_ebi:MODEL1912170004
Original: https://www.ebi.ac.uk/biomodels/MODEL1912170004
"""
...
class SbmlBouchnita2019AMultiscaleModelToDesignTherapeutic(biosim.BioModule):
    """BioModule wrapper for SBML model: Bouchnita2019 - A multiscale model to design therapeutic strategies that overcome drug resistance to tyrosine kinase inhibitors in multiple myeloma."""

    def __init__(self, model_path: str = "data/MODEL1912170004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bouchnita2019AMultiscaleModelToDesignTheraModel1912170004Model = SbmlBouchnita2019AMultiscaleModelToDesignTherapeutic
