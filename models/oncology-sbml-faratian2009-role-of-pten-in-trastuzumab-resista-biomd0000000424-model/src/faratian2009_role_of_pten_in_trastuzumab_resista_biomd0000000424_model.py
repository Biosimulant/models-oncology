...
"""Auto-generated SBML BioModule wrapper for Faratian2009 - Role of PTEN in Trastuzumab resistance.

Source: biomodels_ebi:BIOMD0000000424
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000424
"""
...
class SbmlFaratian2009RoleOfPtenInTrastuzumabResistance(biosim.BioModule):
    """BioModule wrapper for SBML model: Faratian2009 - Role of PTEN in Trastuzumab resistance."""

    def __init__(self, model_path: str = "data/BIOMD0000000424.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Faratian2009RoleOfPtenInTrastuzumabResistaBiomd0000000424Model = SbmlFaratian2009RoleOfPtenInTrastuzumabResistance
