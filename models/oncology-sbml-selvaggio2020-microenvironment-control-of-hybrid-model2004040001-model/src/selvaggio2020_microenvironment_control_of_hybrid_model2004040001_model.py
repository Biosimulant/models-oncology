...
"""Auto-generated SBML BioModule wrapper for Selvaggio2020 - Microenvironment control of hybrid Epithelial-Mesenchymal phenotypes.

Source: biomodels_ebi:MODEL2004040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2004040001
"""
...
class SbmlSelvaggio2020MicroenvironmentControlOfHybridEpithelial(biosim.BioModule):
    """BioModule wrapper for SBML model: Selvaggio2020 - Microenvironment control of hybrid Epithelial-Mesenchymal phenotypes."""

    def __init__(self, model_path: str = "data/MODEL2004040001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Selvaggio2020MicroenvironmentControlOfHybridModel2004040001Model = SbmlSelvaggio2020MicroenvironmentControlOfHybridEpithelial
