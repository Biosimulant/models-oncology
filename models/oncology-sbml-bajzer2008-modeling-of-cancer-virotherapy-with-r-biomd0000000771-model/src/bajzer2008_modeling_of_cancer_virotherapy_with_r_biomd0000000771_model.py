...
"""Auto-generated SBML BioModule wrapper for Bajzer2008 - Modeling of cancer virotherapy with recombinant measles viruses.

Source: biomodels_ebi:BIOMD0000000771
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000771
"""
...
class SbmlBajzer2008ModelingOfCancerVirotherapyWithRecombinant(biosim.BioModule):
    """BioModule wrapper for SBML model: Bajzer2008 - Modeling of cancer virotherapy with recombinant measles viruses."""

    def __init__(self, model_path: str = "data/BIOMD0000000771.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bajzer2008ModelingOfCancerVirotherapyWithRBiomd0000000771Model = SbmlBajzer2008ModelingOfCancerVirotherapyWithRecombinant
