...
"""Auto-generated SBML BioModule wrapper for dePillis2007 - Seeking Bang Bang Solutions of Mixed ImmunoChemotherapy of Tumors.

Source: biomodels_ebi:MODEL2003060001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003060001
"""
...
class SbmlDepillis2007SeekingBangBangSolutionsOfMixed(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2007 - Seeking Bang Bang Solutions of Mixed ImmunoChemotherapy of Tumors."""

    def __init__(self, model_path: str = "data/MODEL2003060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2007SeekingBangBangSolutionsOfMixeModel2003060001Model = SbmlDepillis2007SeekingBangBangSolutionsOfMixed
