...
"""Auto-generated SBML BioModule wrapper for Kim2007 - Crosstalk between Wnt and ERK pathways.

Source: biomodels_ebi:BIOMD0000000149
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000149
"""
...
class SbmlKim2007CrosstalkBetweenWntAndErkPathways(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2007 - Crosstalk between Wnt and ERK pathways."""

    def __init__(self, model_path: str = "data/BIOMD0000000149.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2007CrosstalkBetweenWntAndErkPathwaysBiomd0000000149Model = SbmlKim2007CrosstalkBetweenWntAndErkPathways
