...
"""Auto-generated SBML BioModule wrapper for Hayashi2013 - Extended TNF-induced Signaling with Gene Expression Dynamics (Model B).

Source: biomodels_ebi:MODEL2502170002
Original: https://www.ebi.ac.uk/biomodels/MODEL2502170002
"""
...
class SbmlHayashi2013ExtendedTnfInducedSignalingWithGene(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayashi2013 - Extended TNF-induced Signaling with Gene Expression Dynamics (Model B)."""

    def __init__(self, model_path: str = "data/MODEL2502170002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayashi2013ExtendedTnfInducedSignalingWithModel2502170002Model = SbmlHayashi2013ExtendedTnfInducedSignalingWithGene
