...
"""Auto-generated SBML BioModule wrapper for Gevertz2018 - cancer treatment with oncolytic viruses and dendritic cell injections minimal model.

Source: biomodels_ebi:BIOMD0000000817
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000817
"""
...
class SbmlGevertz2018CancerTreatmentWithOncolyticVirusesAnd2(biosim.BioModule):
    """BioModule wrapper for SBML model: Gevertz2018 - cancer treatment with oncolytic viruses and dendritic cell injections minimal model."""

    def __init__(self, model_path: str = "data/BIOMD0000000817.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gevertz2018CancerTreatmentWithOncolyticViruBiomd0000000817Model = SbmlGevertz2018CancerTreatmentWithOncolyticVirusesAnd2
