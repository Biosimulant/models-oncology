...
"""Auto-generated SBML BioModule wrapper for Nave2018 - prostate cancer model.

Source: biomodels_ebi:MODEL1910030001
Original: https://www.ebi.ac.uk/biomodels/MODEL1910030001
"""
...
class SbmlNave2018ProstateCancerModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Nave2018 - prostate cancer model."""

    def __init__(self, model_path: str = "data/MODEL1910030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nave2018ProstateCancerModelModel1910030001Model = SbmlNave2018ProstateCancerModel
