...
"""Auto-generated SBML BioModule wrapper for Alharbi2019 - Tumor-normal model (TNM) of the development of tumor cells and their impact on normal cell dynamics.

Source: biomodels_ebi:BIOMD0000001037
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001037
"""
...
class SbmlAlharbi2019TumorNormalModelTnmOfTheDevelopmentOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Alharbi2019 - Tumor-normal model (TNM) of the development of tumor cells and their impact on normal cell dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000001037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alharbi2019TumorNormalModelTnmOfTheDeveloBiomd0000001037Model = SbmlAlharbi2019TumorNormalModelTnmOfTheDevelopmentOf
