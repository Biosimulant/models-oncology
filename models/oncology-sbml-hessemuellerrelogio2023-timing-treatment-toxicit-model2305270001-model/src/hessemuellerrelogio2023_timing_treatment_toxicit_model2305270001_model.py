...
"""Auto-generated SBML BioModule wrapper for HesseMuellerRelogio2023 - Timing treatment toxicity of the cancer drug irinotecan based on circadian gene expression profiles.

Source: biomodels_ebi:MODEL2305270001
Original: https://www.ebi.ac.uk/biomodels/MODEL2305270001
"""
...
class SbmlHessemuellerrelogio2023TimingTreatmentToxicityOfThe(biosim.BioModule):
    """BioModule wrapper for SBML model: HesseMuellerRelogio2023 - Timing treatment toxicity of the cancer drug irinotecan based on circadian gene expression profiles."""

    def __init__(self, model_path: str = "data/MODEL2305270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hessemuellerrelogio2023TimingTreatmentToxicitModel2305270001Model = SbmlHessemuellerrelogio2023TimingTreatmentToxicityOfThe
