...
"""Auto-generated SBML BioModule wrapper for Iarosz2015 - brain tumor.

Source: biomodels_ebi:BIOMD0000000775
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000775
"""
...
class SbmlIarosz2015BrainTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: Iarosz2015 - brain tumor."""

    def __init__(self, model_path: str = "data/BIOMD0000000775.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iarosz2015BrainTumorBiomd0000000775Model = SbmlIarosz2015BrainTumor
