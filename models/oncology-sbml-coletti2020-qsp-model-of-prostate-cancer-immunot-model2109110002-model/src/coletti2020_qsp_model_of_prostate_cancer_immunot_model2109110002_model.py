...
"""Auto-generated SBML BioModule wrapper for Coletti2020 - QSP model of prostate cancer immunotherapy.

Source: biomodels_ebi:MODEL2109110002
Original: https://www.ebi.ac.uk/biomodels/MODEL2109110002
"""
...
class SbmlColetti2020QspModelOfProstateCancerImmunotherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Coletti2020 - QSP model of prostate cancer immunotherapy."""

    def __init__(self, model_path: str = "data/MODEL2109110002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Coletti2020QspModelOfProstateCancerImmunotModel2109110002Model = SbmlColetti2020QspModelOfProstateCancerImmunotherapy
