...
"""Auto-generated SBML BioModule wrapper for Evans2005 - Compartmental model for antineoplastic drug topotecan in breast cancer cells.

Source: biomodels_ebi:BIOMD0000000946
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000946
"""
...
class SbmlEvans2005CompartmentalModelForAntineoplasticDrug(biosim.BioModule):
    """BioModule wrapper for SBML model: Evans2005 - Compartmental model for antineoplastic drug topotecan in breast cancer cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000946.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Evans2005CompartmentalModelForAntineoplasticBiomd0000000946Model = SbmlEvans2005CompartmentalModelForAntineoplasticDrug
