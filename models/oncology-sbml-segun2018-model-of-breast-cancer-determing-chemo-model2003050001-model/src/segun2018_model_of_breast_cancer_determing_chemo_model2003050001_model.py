...
"""Auto-generated SBML BioModule wrapper for Segun2018 - model of breast cancer determing Chemotherapy and Keto diet response.

Source: biomodels_ebi:MODEL2003050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003050001
"""
...
class SbmlSegun2018ModelOfBreastCancerDetermingChemotherapyAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Segun2018 - model of breast cancer determing Chemotherapy and Keto diet response."""

    def __init__(self, model_path: str = "data/MODEL2003050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Segun2018ModelOfBreastCancerDetermingChemoModel2003050001Model = SbmlSegun2018ModelOfBreastCancerDetermingChemotherapyAnd
