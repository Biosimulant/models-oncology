...
"""Auto-generated SBML BioModule wrapper for Giani2019 - Computational modeling to predict MAP3K8 effects as mediator of resistance to vemurafenib in thyroid cancer stem cells.

Source: biomodels_ebi:BIOMD0000000883
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000883
"""
...
class SbmlGiani2019ComputationalModelingToPredictMap3k8Effects(biosim.BioModule):
    """BioModule wrapper for SBML model: Giani2019 - Computational modeling to predict MAP3K8 effects as mediator of resistance to vemurafenib in thyroid cancer stem cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000883.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Giani2019ComputationalModelingToPredictMap3Biomd0000000883Model = SbmlGiani2019ComputationalModelingToPredictMap3k8Effects
