...
"""Auto-generated SBML BioModule wrapper for Nikolaev2019 - Immunobiochemical reconstruction of influenza lung infection-melanoma skin cancer interactions.

Source: biomodels_ebi:BIOMD0000000865
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000865
"""
...
class SbmlNikolaev2019ImmunobiochemicalReconstructionOfInfluenza(biosim.BioModule):
    """BioModule wrapper for SBML model: Nikolaev2019 - Immunobiochemical reconstruction of influenza lung infection-melanoma skin cancer interactions."""

    def __init__(self, model_path: str = "data/BIOMD0000000865.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nikolaev2019ImmunobiochemicalReconstructionOfBiomd0000000865Model = SbmlNikolaev2019ImmunobiochemicalReconstructionOfInfluenza
