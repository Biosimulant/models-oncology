...
"""Auto-generated SBML BioModule wrapper for Gulhane2022 - Sphingolipid metabolism and PI3K-AKT axis in NSCLC.

Source: biomodels_ebi:MODEL2402290001
Original: https://www.ebi.ac.uk/biomodels/MODEL2402290001
"""
...
class SbmlGulhane2022SphingolipidMetabolismAndPi3kAktAxisIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Gulhane2022 - Sphingolipid metabolism and PI3K-AKT axis in NSCLC."""

    def __init__(self, model_path: str = "data/MODEL2402290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gulhane2022SphingolipidMetabolismAndPi3kAktModel2402290001Model = SbmlGulhane2022SphingolipidMetabolismAndPi3kAktAxisIn
