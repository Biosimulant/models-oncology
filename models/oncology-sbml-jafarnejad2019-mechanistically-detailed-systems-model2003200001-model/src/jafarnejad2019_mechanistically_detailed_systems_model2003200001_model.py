...
"""Auto-generated SBML BioModule wrapper for Jafarnejad2019 - Mechanistically detailed systems biology modeling of the HGF/Met pathway in hepatocellular carcinoma.

Source: biomodels_ebi:MODEL2003200001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003200001
"""
...
class SbmlJafarnejad2019MechanisticallyDetailedSystemsBiology(biosim.BioModule):
    """BioModule wrapper for SBML model: Jafarnejad2019 - Mechanistically detailed systems biology modeling of the HGF/Met pathway in hepatocellular carcinoma."""

    def __init__(self, model_path: str = "data/MODEL2003200001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jafarnejad2019MechanisticallyDetailedSystemsModel2003200001Model = SbmlJafarnejad2019MechanisticallyDetailedSystemsBiology
