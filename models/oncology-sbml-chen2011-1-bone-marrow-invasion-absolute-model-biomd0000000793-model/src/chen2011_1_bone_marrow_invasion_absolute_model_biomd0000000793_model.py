...
"""Auto-generated SBML BioModule wrapper for Chen2011/1 - bone marrow invasion absolute model.

Source: biomodels_ebi:BIOMD0000000793
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000793
"""
...
class SbmlChen20111BoneMarrowInvasionAbsoluteModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2011/1 - bone marrow invasion absolute model."""

    def __init__(self, model_path: str = "data/BIOMD0000000793.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chen20111BoneMarrowInvasionAbsoluteModelBiomd0000000793Model = SbmlChen20111BoneMarrowInvasionAbsoluteModel
