...
"""Auto-generated SBML BioModule wrapper for Mkango2019 - Dynamics of Breast Cancer under DifferentRates of Chemoradiotherapy.

Source: biomodels_ebi:MODEL1912120005
Original: https://www.ebi.ac.uk/biomodels/MODEL1912120005
"""
...
class SbmlMkango2019DynamicsOfBreastCancerUnderDifferentrates(biosim.BioModule):
    """BioModule wrapper for SBML model: Mkango2019 - Dynamics of Breast Cancer under DifferentRates of Chemoradiotherapy."""

    def __init__(self, model_path: str = "data/MODEL1912120005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mkango2019DynamicsOfBreastCancerUnderDiffeModel1912120005Model = SbmlMkango2019DynamicsOfBreastCancerUnderDifferentrates
