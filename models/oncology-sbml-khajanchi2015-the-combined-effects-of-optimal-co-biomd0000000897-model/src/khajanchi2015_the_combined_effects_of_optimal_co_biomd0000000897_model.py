...
"""Auto-generated SBML BioModule wrapper for Khajanchi2015 - The combined effects of optimal control in cancer remission.

Source: biomodels_ebi:BIOMD0000000897
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000897
"""
...
class SbmlKhajanchi2015TheCombinedEffectsOfOptimalControlIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Khajanchi2015 - The combined effects of optimal control in cancer remission."""

    def __init__(self, model_path: str = "data/BIOMD0000000897.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khajanchi2015TheCombinedEffectsOfOptimalCoBiomd0000000897Model = SbmlKhajanchi2015TheCombinedEffectsOfOptimalControlIn
