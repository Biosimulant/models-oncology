...
"""Auto-generated SBML BioModule wrapper for Yang2012 - cancer growth with angiogenesis.

Source: biomodels_ebi:BIOMD0000000796
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000796
"""
...
class SbmlYang2012CancerGrowthWithAngiogenesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Yang2012 - cancer growth with angiogenesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000796.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yang2012CancerGrowthWithAngiogenesisBiomd0000000796Model = SbmlYang2012CancerGrowthWithAngiogenesis
