...
"""Auto-generated SBML BioModule wrapper for Aghakhani2022 - Human breast cancer-associated fibroblast model.

Source: biomodels_ebi:MODEL2307090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2307090001
"""
...
class SbmlAghakhani2022HumanBreastCancerAssociatedFibroblast(biosim.BioModule):
    """BioModule wrapper for SBML model: Aghakhani2022 - Human breast cancer-associated fibroblast model."""

    def __init__(self, model_path: str = "data/MODEL2307090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aghakhani2022HumanBreastCancerAssociatedFibModel2307090001Model = SbmlAghakhani2022HumanBreastCancerAssociatedFibroblast
