...
"""Auto-generated SBML BioModule wrapper for Monro2008 - chemotherapy resistance.

Source: biomodels_ebi:BIOMD0000000776
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000776
"""
...
class SbmlMonro2008ChemotherapyResistance(biosim.BioModule):
    """BioModule wrapper for SBML model: Monro2008 - chemotherapy resistance."""

    def __init__(self, model_path: str = "data/BIOMD0000000776.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Monro2008ChemotherapyResistanceBiomd0000000776Model = SbmlMonro2008ChemotherapyResistance
