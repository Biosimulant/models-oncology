...
"""Auto-generated SBML BioModule wrapper for Rommelfanger2011 - Gompertz model of melanoma tumor therapy with vesicular stomatitis virus.

Source: biomodels_ebi:MODEL2109110003
Original: https://www.ebi.ac.uk/biomodels/MODEL2109110003
"""
...
class SbmlRommelfanger2011GompertzModelOfMelanomaTumorTherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Rommelfanger2011 - Gompertz model of melanoma tumor therapy with vesicular stomatitis virus."""

    def __init__(self, model_path: str = "data/MODEL2109110003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rommelfanger2011GompertzModelOfMelanomaTumoModel2109110003Model = SbmlRommelfanger2011GompertzModelOfMelanomaTumorTherapy
