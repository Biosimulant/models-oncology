...
"""Auto-generated SBML BioModule wrapper for West2019 - Cellular interactions constrain tumor growth.

Source: biomodels_ebi:BIOMD0000000820
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000820
"""
...
class SbmlWest2019CellularInteractionsConstrainTumorGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: West2019 - Cellular interactions constrain tumor growth."""

    def __init__(self, model_path: str = "data/BIOMD0000000820.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
West2019CellularInteractionsConstrainTumorGBiomd0000000820Model = SbmlWest2019CellularInteractionsConstrainTumorGrowth
