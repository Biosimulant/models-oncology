...
"""Auto-generated SBML BioModule wrapper for Alharbi2019 - Tumor-normal-vitamins model (TNVM) of the effects of vitamins on delaying the growth of tumor cells.

Source: biomodels_ebi:BIOMD0000001038
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001038
"""
...
class SbmlAlharbi2019TumorNormalVitaminsModelTnvmOfTheEffects(biosim.BioModule):
    """BioModule wrapper for SBML model: Alharbi2019 - Tumor-normal-vitamins model (TNVM) of the effects of vitamins on delaying the growth of tumor cells."""

    def __init__(self, model_path: str = "data/BIOMD0000001038.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Alharbi2019TumorNormalVitaminsModelTnvmOfBiomd0000001038Model = SbmlAlharbi2019TumorNormalVitaminsModelTnvmOfTheEffects
