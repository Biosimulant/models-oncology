...
"""Auto-generated SBML BioModule wrapper for Schattler2016 - Dynamical properties of a minimally parameterized mathematical model for metronomic chemotherapy.

Source: biomodels_ebi:MODEL2002030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002030001
"""
...
class SbmlSchattler2016DynamicalPropertiesOfAMinimally(biosim.BioModule):
    """BioModule wrapper for SBML model: Schattler2016 - Dynamical properties of a minimally parameterized mathematical model for metronomic chemotherapy."""

    def __init__(self, model_path: str = "data/MODEL2002030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schattler2016DynamicalPropertiesOfAMinimallModel2002030001Model = SbmlSchattler2016DynamicalPropertiesOfAMinimally
