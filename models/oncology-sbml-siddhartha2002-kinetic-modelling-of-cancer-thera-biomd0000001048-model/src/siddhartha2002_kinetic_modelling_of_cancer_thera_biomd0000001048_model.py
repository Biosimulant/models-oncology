...
"""Auto-generated SBML BioModule wrapper for Siddhartha2002 - Kinetic modelling of cancer therapies.

Source: biomodels_ebi:BIOMD0000001048
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001048
"""
...
class SbmlSiddhartha2002KineticModellingOfCancerTherapies(biosim.BioModule):
    """BioModule wrapper for SBML model: Siddhartha2002 - Kinetic modelling of cancer therapies."""

    def __init__(self, model_path: str = "data/BIOMD0000001048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Siddhartha2002KineticModellingOfCancerTheraBiomd0000001048Model = SbmlSiddhartha2002KineticModellingOfCancerTherapies
