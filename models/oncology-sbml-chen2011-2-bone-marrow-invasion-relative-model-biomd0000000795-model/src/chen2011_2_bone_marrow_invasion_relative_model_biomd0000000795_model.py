...
"""Auto-generated SBML BioModule wrapper for Chen2011/2 - bone marrow invasion relative model.

Source: biomodels_ebi:BIOMD0000000795
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000795
"""
...
class SbmlChen20112BoneMarrowInvasionRelativeModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2011/2 - bone marrow invasion relative model."""

    def __init__(self, model_path: str = "data/BIOMD0000000795.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chen20112BoneMarrowInvasionRelativeModelBiomd0000000795Model = SbmlChen20112BoneMarrowInvasionRelativeModel
