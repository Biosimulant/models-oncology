...
"""Auto-generated SBML BioModule wrapper for Abernathy2016 - glioblastoma treatment.

Source: biomodels_ebi:BIOMD0000000757
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000757
"""
...
class SbmlAbernathy2016GlioblastomaTreatment(biosim.BioModule):
    """BioModule wrapper for SBML model: Abernathy2016 - glioblastoma treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000757.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Abernathy2016GlioblastomaTreatmentBiomd0000000757Model = SbmlAbernathy2016GlioblastomaTreatment
