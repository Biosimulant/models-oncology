...
"""Auto-generated SBML BioModule wrapper for Tham2008 - PDmodel, Tumour shrinkage by gemcitabine and carboplatin.

Source: biomodels_ebi:BIOMD0000000234
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000234
"""
...
class SbmlTham2008PdmodelTumourShrinkageByGemcitabineAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Tham2008 - PDmodel, Tumour shrinkage by gemcitabine and carboplatin."""

    def __init__(self, model_path: str = "data/BIOMD0000000234.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tham2008PdmodelTumourShrinkageByGemcitabineBiomd0000000234Model = SbmlTham2008PdmodelTumourShrinkageByGemcitabineAnd
