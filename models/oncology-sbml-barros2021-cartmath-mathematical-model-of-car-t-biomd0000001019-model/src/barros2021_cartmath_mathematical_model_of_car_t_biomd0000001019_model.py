...
"""Auto-generated SBML BioModule wrapper for Barros2021 - CARTmath, Mathematical Model of CAR-T Immunotherapy in HDLM-2 cell line.

Source: biomodels_ebi:BIOMD0000001019
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001019
"""
...
class SbmlBarros2021CartmathMathematicalModelOfCarT(biosim.BioModule):
    """BioModule wrapper for SBML model: Barros2021 - CARTmath, Mathematical Model of CAR-T Immunotherapy in HDLM-2 cell line."""

    def __init__(self, model_path: str = "data/BIOMD0000001019.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Barros2021CartmathMathematicalModelOfCarTBiomd0000001019Model = SbmlBarros2021CartmathMathematicalModelOfCarT
