...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1909090002)
**Standard**: sbml
**Authors**: Wei, H.C.
...
models:
  - path: ../../models/oncology-sbml-wei2019-mathematical-modeling-of-tumor-growth-th-model1909090002-model
    alias: model
```
