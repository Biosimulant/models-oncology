...
"""Auto-generated SBML BioModule wrapper for Chance1960_Glycolysis_Respiration.

Source: biomodels_ebi:BIOMD0000000281
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000281
"""
...
class SbmlChance1960GlycolysisRespiration(biosim.BioModule):
    """BioModule wrapper for SBML model: Chance1960_Glycolysis_Respiration."""

    def __init__(self, model_path: str = "data/BIOMD0000000281.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chance1960GlycolysisRespirationBiomd0000000281Model = SbmlChance1960GlycolysisRespiration
