...
"""Auto-generated SBML BioModule wrapper for Shariatpanahi2018 - Mathematical modeling of tumor-induced immunosuppression by myeloid-derived suppressor cells.

Source: biomodels_ebi:MODEL1909090003
Original: https://www.ebi.ac.uk/biomodels/MODEL1909090003
"""
...
class SbmlShariatpanahi2018MathematicalModelingOfTumorInduced(biosim.BioModule):
    """BioModule wrapper for SBML model: Shariatpanahi2018 - Mathematical modeling of tumor-induced immunosuppression by myeloid-derived suppressor cells."""

    def __init__(self, model_path: str = "data/MODEL1909090003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shariatpanahi2018MathematicalModelingOfTumorModel1909090003Model = SbmlShariatpanahi2018MathematicalModelingOfTumorInduced
