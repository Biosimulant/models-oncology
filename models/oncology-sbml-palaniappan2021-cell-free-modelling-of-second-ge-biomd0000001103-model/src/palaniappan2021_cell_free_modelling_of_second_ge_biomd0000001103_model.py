...
"""Auto-generated SBML BioModule wrapper for Palaniappan2021 - Cell free modelling of second generation Toehold switches.

Source: biomodels_ebi:BIOMD0000001103
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001103
"""
...
class SbmlPalaniappan2021CellFreeModellingOfSecondGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Palaniappan2021 - Cell free modelling of second generation Toehold switches."""

    def __init__(self, model_path: str = "data/BIOMD0000001103.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Palaniappan2021CellFreeModellingOfSecondGeBiomd0000001103Model = SbmlPalaniappan2021CellFreeModellingOfSecondGeneration
