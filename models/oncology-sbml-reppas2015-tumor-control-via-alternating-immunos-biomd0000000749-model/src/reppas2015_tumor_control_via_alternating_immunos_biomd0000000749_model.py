...
"""Auto-generated SBML BioModule wrapper for Reppas2015 - tumor control via alternating immunostimulating and immunosuppressive phases.

Source: biomodels_ebi:BIOMD0000000749
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000749
"""
...
class SbmlReppas2015TumorControlViaAlternatingImmunostimulating(biosim.BioModule):
    """BioModule wrapper for SBML model: Reppas2015 - tumor control via alternating immunostimulating and immunosuppressive phases."""

    def __init__(self, model_path: str = "data/BIOMD0000000749.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reppas2015TumorControlViaAlternatingImmunosBiomd0000000749Model = SbmlReppas2015TumorControlViaAlternatingImmunostimulating
