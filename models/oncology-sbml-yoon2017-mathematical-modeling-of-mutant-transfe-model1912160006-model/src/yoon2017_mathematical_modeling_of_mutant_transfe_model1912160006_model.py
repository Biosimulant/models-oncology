...
"""Auto-generated SBML BioModule wrapper for Yoon2017 - Mathematical Modeling of Mutant Transferrin-CRM107 Molecular Conjugates for Cancer Therapy.

Source: biomodels_ebi:MODEL1912160006
Original: https://www.ebi.ac.uk/biomodels/MODEL1912160006
"""
...
class SbmlYoon2017MathematicalModelingOfMutantTransferrinCrm107(biosim.BioModule):
    """BioModule wrapper for SBML model: Yoon2017 - Mathematical Modeling of Mutant Transferrin-CRM107 Molecular Conjugates for Cancer Therapy."""

    def __init__(self, model_path: str = "data/MODEL1912160006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yoon2017MathematicalModelingOfMutantTransfeModel1912160006Model = SbmlYoon2017MathematicalModelingOfMutantTransferrinCrm107
