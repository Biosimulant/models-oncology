...
Source: biomodels_ebi:MODEL2002250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2002250001
"""
...
class SbmlRouhimoghadam2018Gpr30Pi3kMapkStatSignalingPathwayIn(biosim.BioModule):
    """BioModule wrapper for SBML model: Rouhimoghadam2018 - GPR30/PI3K/MAPK/STAT signaling pathway in normal and cancer cells."""

    def __init__(self, model_path: str = "data/MODEL2002250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rouhimoghadam2018Gpr30Pi3kMapkStatSignalingModel2002250001Model = SbmlRouhimoghadam2018Gpr30Pi3kMapkStatSignalingPathwayIn
