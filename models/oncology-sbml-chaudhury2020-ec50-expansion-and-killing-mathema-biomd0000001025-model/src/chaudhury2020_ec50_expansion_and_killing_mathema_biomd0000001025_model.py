...
"""Auto-generated SBML BioModule wrapper for Chaudhury2020 - EC50 expansion and killing mathematical model of CAR-T cell and tumour kinetics.

Source: biomodels_ebi:BIOMD0000001025
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001025
"""
...
class SbmlChaudhury2020Ec50ExpansionAndKillingMathematicalModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Chaudhury2020 - EC50 expansion and killing mathematical model of CAR-T cell and tumour kinetics."""

    def __init__(self, model_path: str = "data/BIOMD0000001025.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chaudhury2020Ec50ExpansionAndKillingMathemaBiomd0000001025Model = SbmlChaudhury2020Ec50ExpansionAndKillingMathematicalModel
