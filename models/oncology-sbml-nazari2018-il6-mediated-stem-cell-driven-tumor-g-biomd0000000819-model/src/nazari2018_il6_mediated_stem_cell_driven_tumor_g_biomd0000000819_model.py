...
"""Auto-generated SBML BioModule wrapper for Nazari2018 - IL6 mediated stem cell driven tumor growth and targeted treatment.

Source: biomodels_ebi:BIOMD0000000819
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000819
"""
...
class SbmlNazari2018Il6MediatedStemCellDrivenTumorGrowthAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Nazari2018 - IL6 mediated stem cell driven tumor growth and targeted treatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000819.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nazari2018Il6MediatedStemCellDrivenTumorGBiomd0000000819Model = SbmlNazari2018Il6MediatedStemCellDrivenTumorGrowthAnd
