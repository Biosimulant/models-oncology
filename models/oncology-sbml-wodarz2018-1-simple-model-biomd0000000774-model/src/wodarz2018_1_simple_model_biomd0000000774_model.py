...
"""Auto-generated SBML BioModule wrapper for Wodarz2018/1 - simple model.

Source: biomodels_ebi:BIOMD0000000774
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000774
"""
...
class SbmlWodarz20181SimpleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2018/1 - simple model."""

    def __init__(self, model_path: str = "data/BIOMD0000000774.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz20181SimpleModelBiomd0000000774Model = SbmlWodarz20181SimpleModel
