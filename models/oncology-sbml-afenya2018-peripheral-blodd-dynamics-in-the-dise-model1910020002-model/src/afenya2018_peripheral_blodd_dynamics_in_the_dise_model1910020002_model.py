...
"""Auto-generated SBML BioModule wrapper for Afenya2018 - peripheral blodd dynamics in the disease state.

Source: biomodels_ebi:MODEL1910020002
Original: https://www.ebi.ac.uk/biomodels/MODEL1910020002
"""
...
class SbmlAfenya2018PeripheralBloddDynamicsInTheDiseaseState(biosim.BioModule):
    """BioModule wrapper for SBML model: Afenya2018 - peripheral blodd dynamics in the disease state."""

    def __init__(self, model_path: str = "data/MODEL1910020002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Afenya2018PeripheralBloddDynamicsInTheDiseModel1910020002Model = SbmlAfenya2018PeripheralBloddDynamicsInTheDiseaseState
