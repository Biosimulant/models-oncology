...
"""Auto-generated SBML BioModule wrapper for Eftimie2010 - immunity to melanoma.

Source: biomodels_ebi:BIOMD0000000768
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000768
"""
...
class SbmlEftimie2010ImmunityToMelanoma(biosim.BioModule):
    """BioModule wrapper for SBML model: Eftimie2010 - immunity to melanoma."""

    def __init__(self, model_path: str = "data/BIOMD0000000768.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Eftimie2010ImmunityToMelanomaBiomd0000000768Model = SbmlEftimie2010ImmunityToMelanoma
