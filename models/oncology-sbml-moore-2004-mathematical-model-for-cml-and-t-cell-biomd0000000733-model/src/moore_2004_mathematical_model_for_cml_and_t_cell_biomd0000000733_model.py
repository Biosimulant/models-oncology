...
"""Auto-generated SBML BioModule wrapper for Moore_2004_Mathematical model for CML and T cell interaction.

Source: biomodels_ebi:BIOMD0000000733
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000733
"""
...
class SbmlMoore2004MathematicalModelForCmlAndTCellInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Moore_2004_Mathematical model for CML and T cell interaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000733.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Moore2004MathematicalModelForCmlAndTCellBiomd0000000733Model = SbmlMoore2004MathematicalModelForCmlAndTCellInteraction
