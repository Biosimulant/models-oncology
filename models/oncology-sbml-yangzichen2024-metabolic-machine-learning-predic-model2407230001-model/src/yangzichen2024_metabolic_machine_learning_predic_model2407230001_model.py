...
"""Auto-generated SBML BioModule wrapper for YangziChen2024 - Metabolic Machine Learning Predictor Model for Diagnosis of Gastric Cancer.

Source: biomodels_ebi:MODEL2407230001
Original: https://www.ebi.ac.uk/biomodels/MODEL2407230001
"""
...
class SbmlYangzichen2024MetabolicMachineLearningPredictorModel(biosim.BioModule):
    """BioModule wrapper for SBML model: YangziChen2024 - Metabolic Machine Learning Predictor Model for Diagnosis of Gastric Cancer."""

    def __init__(self, model_path: str = "data/MODEL2407230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yangzichen2024MetabolicMachineLearningPredicModel2407230001Model = SbmlYangzichen2024MetabolicMachineLearningPredictorModel
