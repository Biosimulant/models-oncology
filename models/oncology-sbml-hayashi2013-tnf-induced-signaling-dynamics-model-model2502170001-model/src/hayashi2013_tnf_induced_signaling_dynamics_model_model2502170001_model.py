...
"""Auto-generated SBML BioModule wrapper for Hayashi2013 - TNF-induced Signaling Dynamics  (Model A).

Source: biomodels_ebi:MODEL2502170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2502170001
"""
...
class SbmlHayashi2013TnfInducedSignalingDynamicsModelA(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayashi2013 - TNF-induced Signaling Dynamics  (Model A)."""

    def __init__(self, model_path: str = "data/MODEL2502170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayashi2013TnfInducedSignalingDynamicsModelModel2502170001Model = SbmlHayashi2013TnfInducedSignalingDynamicsModelA
