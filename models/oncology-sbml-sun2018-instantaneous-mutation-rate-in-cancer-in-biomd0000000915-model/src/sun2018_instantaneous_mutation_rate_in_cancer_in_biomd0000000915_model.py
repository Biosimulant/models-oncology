...
"""Auto-generated SBML BioModule wrapper for Sun2018 - Instantaneous mutation rate in cancer initiation and progression.

Source: biomodels_ebi:BIOMD0000000915
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000915
"""
...
class SbmlSun2018InstantaneousMutationRateInCancerInitiation(biosim.BioModule):
    """BioModule wrapper for SBML model: Sun2018 - Instantaneous mutation rate in cancer initiation and progression."""

    def __init__(self, model_path: str = "data/BIOMD0000000915.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sun2018InstantaneousMutationRateInCancerInBiomd0000000915Model = SbmlSun2018InstantaneousMutationRateInCancerInitiation
