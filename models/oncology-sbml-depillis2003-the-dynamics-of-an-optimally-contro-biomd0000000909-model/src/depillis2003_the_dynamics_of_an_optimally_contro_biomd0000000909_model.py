...
"""Auto-generated SBML BioModule wrapper for dePillis2003 - The dynamics of an optimally controlled tumor model: A case study.

Source: biomodels_ebi:BIOMD0000000909
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000909
"""
...
class SbmlDepillis2003TheDynamicsOfAnOptimallyControlledTumor(biosim.BioModule):
    """BioModule wrapper for SBML model: dePillis2003 - The dynamics of an optimally controlled tumor model: A case study."""

    def __init__(self, model_path: str = "data/BIOMD0000000909.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depillis2003TheDynamicsOfAnOptimallyControBiomd0000000909Model = SbmlDepillis2003TheDynamicsOfAnOptimallyControlledTumor
