...
"""Auto-generated SBML BioModule wrapper for Chaudhury2020 - First order expansion model of CAR-T cell and tumour kinetics.

Source: biomodels_ebi:MODEL2109110005
Original: https://www.ebi.ac.uk/biomodels/MODEL2109110005
"""
...
class SbmlChaudhury2020FirstOrderExpansionModelOfCarTCellAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Chaudhury2020 - First order expansion model of CAR-T cell and tumour kinetics."""

    def __init__(self, model_path: str = "data/MODEL2109110005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chaudhury2020FirstOrderExpansionModelOfCarModel2109110005Model = SbmlChaudhury2020FirstOrderExpansionModelOfCarTCellAnd
