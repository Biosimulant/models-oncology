...
"""Auto-generated SBML BioModule wrapper for Sotolongo-Costa2003 - Behavior of tumors under nonstationary therapy.

Source: biomodels_ebi:BIOMD0000000785
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000785
"""
...
class SbmlSotolongoCosta2003BehaviorOfTumorsUnderNonstationary(biosim.BioModule):
    """BioModule wrapper for SBML model: Sotolongo-Costa2003 - Behavior of tumors under nonstationary therapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000785.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SotolongoCosta2003BehaviorOfTumorsUnderNonBiomd0000000785Model = SbmlSotolongoCosta2003BehaviorOfTumorsUnderNonstationary
