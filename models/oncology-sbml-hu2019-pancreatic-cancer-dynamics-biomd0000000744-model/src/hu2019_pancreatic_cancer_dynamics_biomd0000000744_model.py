...
"""Auto-generated SBML BioModule wrapper for Hu2019 - Pancreatic cancer dynamics.

Source: biomodels_ebi:BIOMD0000000744
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000744
"""
...
class SbmlHu2019PancreaticCancerDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Hu2019 - Pancreatic cancer dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000744.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hu2019PancreaticCancerDynamicsBiomd0000000744Model = SbmlHu2019PancreaticCancerDynamics
