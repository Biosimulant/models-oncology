...
"""Auto-generated SBML BioModule wrapper for Unni2019 - Mathematical Modeling, Analysis, and Simulation of Tumor Dynamics with Drug Interventions.

Source: biomodels_ebi:BIOMD0000000888
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000888
"""
...
class SbmlUnni2019MathematicalModelingAnalysisAndSimulationOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Unni2019 - Mathematical Modeling, Analysis, and Simulation of Tumor Dynamics with Drug Interventions."""

    def __init__(self, model_path: str = "data/BIOMD0000000888.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Unni2019MathematicalModelingAnalysisAndSimuBiomd0000000888Model = SbmlUnni2019MathematicalModelingAnalysisAndSimulationOf
