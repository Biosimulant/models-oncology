...
"""Auto-generated SBML BioModule wrapper for Kemmer2022 - Disentangling ERBB Signaling in Breast Cancer Subtypes – a Model-Based Analysis.

Source: biomodels_ebi:MODEL2205030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2205030001
"""
...
class SbmlKemmer2022DisentanglingErbbSignalingInBreastCancer(biosim.BioModule):
    """BioModule wrapper for SBML model: Kemmer2022 - Disentangling ERBB Signaling in Breast Cancer Subtypes – a Model-Based Analysis."""

    def __init__(self, model_path: str = "data/MODEL2205030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kemmer2022DisentanglingErbbSignalingInBreasModel2205030001Model = SbmlKemmer2022DisentanglingErbbSignalingInBreastCancer
