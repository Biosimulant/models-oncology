...
"""Auto-generated SBML BioModule wrapper for Zhu2015 - Combined gemcitabine and birinapant in pancreatic cancer cells - basic PD model.

Source: biomodels_ebi:BIOMD0000000668
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000668
"""
...
class SbmlZhu2015CombinedGemcitabineAndBirinapantInPancreatic(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhu2015 - Combined gemcitabine and birinapant in pancreatic cancer cells - basic PD model."""

    def __init__(self, model_path: str = "data/BIOMD0000000668.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhu2015CombinedGemcitabineAndBirinapantInPBiomd0000000668Model = SbmlZhu2015CombinedGemcitabineAndBirinapantInPancreatic
