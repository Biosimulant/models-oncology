...
"""Auto-generated SBML BioModule wrapper for Celiku_Friedenberg_2022 -- Probabilistic Model Checking of Cancer Metabolism.

Source: biomodels_ebi:MODEL2207180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2207180001
"""
...
class SbmlCelikuFriedenberg2022ProbabilisticModelCheckingOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Celiku_Friedenberg_2022 -- Probabilistic Model Checking of Cancer Metabolism."""

    def __init__(self, model_path: str = "data/MODEL2207180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CelikuFriedenberg2022ProbabilisticModelChecModel2207180001Model = SbmlCelikuFriedenberg2022ProbabilisticModelCheckingOf
