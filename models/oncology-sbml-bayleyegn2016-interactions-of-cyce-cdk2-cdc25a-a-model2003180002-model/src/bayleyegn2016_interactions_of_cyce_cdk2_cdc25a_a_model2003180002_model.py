...
"""Auto-generated SBML BioModule wrapper for Bayleyegn2016 - interactions of CycE/Cdk2, Cdc25A, and P27 Kip1 in a core cancer subnetwork.

Source: biomodels_ebi:MODEL2003180002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003180002
"""
...
class SbmlBayleyegn2016InteractionsOfCyceCdk2Cdc25aAndP27Kip1(biosim.BioModule):
    """BioModule wrapper for SBML model: Bayleyegn2016 - interactions of CycE/Cdk2, Cdc25A, and P27 Kip1 in a core cancer subnetwork."""

    def __init__(self, model_path: str = "data/MODEL2003180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bayleyegn2016InteractionsOfCyceCdk2Cdc25aAModel2003180002Model = SbmlBayleyegn2016InteractionsOfCyceCdk2Cdc25aAndP27Kip1
