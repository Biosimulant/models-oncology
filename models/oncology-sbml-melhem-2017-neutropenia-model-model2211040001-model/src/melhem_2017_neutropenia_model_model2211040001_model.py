...
"""Auto-generated SBML BioModule wrapper for Melhem 2017 -  Neutropenia Model.

Source: biomodels_ebi:MODEL2211040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2211040001
"""
...
class SbmlMelhem2017NeutropeniaModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Melhem 2017 -  Neutropenia Model."""

    def __init__(self, model_path: str = "data/MODEL2211040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Melhem2017NeutropeniaModelModel2211040001Model = SbmlMelhem2017NeutropeniaModel
