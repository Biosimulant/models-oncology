...
"""Auto-generated SBML BioModule wrapper for Wodarz2018/2 - model with transit amplifying cells.

Source: biomodels_ebi:BIOMD0000000773
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000773
"""
...
class SbmlWodarz20182ModelWithTransitAmplifyingCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2018/2 - model with transit amplifying cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000773.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz20182ModelWithTransitAmplifyingCellsBiomd0000000773Model = SbmlWodarz20182ModelWithTransitAmplifyingCells
