...
"""Auto-generated SBML BioModule wrapper for Iwamoto2010 - Cell cycle reponse to DNA damage.

Source: biomodels_ebi:BIOMD0000000939
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000939
"""
...
class SbmlIwamoto2010CellCycleReponseToDnaDamage(biosim.BioModule):
    """BioModule wrapper for SBML model: Iwamoto2010 - Cell cycle reponse to DNA damage."""

    def __init__(self, model_path: str = "data/BIOMD0000000939.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Iwamoto2010CellCycleReponseToDnaDamageBiomd0000000939Model = SbmlIwamoto2010CellCycleReponseToDnaDamage
