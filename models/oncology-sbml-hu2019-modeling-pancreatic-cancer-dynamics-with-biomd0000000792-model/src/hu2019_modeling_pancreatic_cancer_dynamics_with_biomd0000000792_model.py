...
"""Auto-generated SBML BioModule wrapper for Hu2019 - Modeling Pancreatic Cancer Dynamics with Immunotherapy.

Source: biomodels_ebi:BIOMD0000000792
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000792
"""
...
class SbmlHu2019ModelingPancreaticCancerDynamicsWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Hu2019 - Modeling Pancreatic Cancer Dynamics with Immunotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000792.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hu2019ModelingPancreaticCancerDynamicsWithBiomd0000000792Model = SbmlHu2019ModelingPancreaticCancerDynamicsWith
