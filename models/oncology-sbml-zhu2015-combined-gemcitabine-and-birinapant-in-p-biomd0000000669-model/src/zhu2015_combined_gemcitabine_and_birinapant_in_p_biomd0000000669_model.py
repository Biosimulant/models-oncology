...
"""Auto-generated SBML BioModule wrapper for Zhu2015 - Combined gemcitabine and birinapant in pancreatic cancer cells - mechanistic PD model.

Source: biomodels_ebi:BIOMD0000000669
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000669
"""
...
class SbmlZhu2015CombinedGemcitabineAndBirinapantInPancreatic2(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhu2015 - Combined gemcitabine and birinapant in pancreatic cancer cells - mechanistic PD model."""

    def __init__(self, model_path: str = "data/BIOMD0000000669.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhu2015CombinedGemcitabineAndBirinapantInPBiomd0000000669Model = SbmlZhu2015CombinedGemcitabineAndBirinapantInPancreatic2
