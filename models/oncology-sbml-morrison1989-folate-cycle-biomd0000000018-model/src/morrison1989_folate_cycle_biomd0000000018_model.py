...
"""Auto-generated SBML BioModule wrapper for Morrison1989 - Folate Cycle.

Source: biomodels_ebi:BIOMD0000000018
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000018
"""
...
class SbmlMorrison1989FolateCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Morrison1989 - Folate Cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000018.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Morrison1989FolateCycleBiomd0000000018Model = SbmlMorrison1989FolateCycle
