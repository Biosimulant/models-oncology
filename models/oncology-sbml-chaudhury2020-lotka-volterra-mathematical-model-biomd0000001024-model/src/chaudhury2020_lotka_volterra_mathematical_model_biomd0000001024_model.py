...
"""Auto-generated SBML BioModule wrapper for Chaudhury2020 - Lotka-Volterra mathematical model of CAR-T cell and tumour kinetics.

Source: biomodels_ebi:BIOMD0000001024
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001024
"""
...
class SbmlChaudhury2020LotkaVolterraMathematicalModelOfCarT(biosim.BioModule):
    """BioModule wrapper for SBML model: Chaudhury2020 - Lotka-Volterra mathematical model of CAR-T cell and tumour kinetics."""

    def __init__(self, model_path: str = "data/BIOMD0000001024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chaudhury2020LotkaVolterraMathematicalModelBiomd0000001024Model = SbmlChaudhury2020LotkaVolterraMathematicalModelOfCarT
