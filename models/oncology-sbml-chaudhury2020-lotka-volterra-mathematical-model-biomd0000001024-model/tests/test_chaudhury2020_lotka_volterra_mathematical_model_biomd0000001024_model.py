...
"""Auto-generated tests for Chaudhury2020LotkaVolterraMathematicalModelBiomd0000001024Model.
...
from src.chaudhury2020_lotka_volterra_mathematical_model_biomd0000001024_model import Chaudhury2020LotkaVolterraMathematicalModelBiomd0000001024Model  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = Chaudhury2020LotkaVolterraMathematicalModelBiomd0000001024Model()
...
def test_advance_produces_outputs() -> None:
    module = Chaudhury2020LotkaVolterraMathematicalModelBiomd0000001024Model(min_dt=0.1)
