#!/usr/bin/env python3
"""Run generated space: oncology-therapy-response-combo-0030."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'oncology-therapy-response-combo-0030')} duration={duration} tick_dt={tick_dt}")
