#!/usr/bin/env python3
"""Run generated space: oncology-therapy-response-combo-0003."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-oncology": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'oncology-therapy-response-combo-0003')} duration={duration} tick_dt={tick_dt}")
